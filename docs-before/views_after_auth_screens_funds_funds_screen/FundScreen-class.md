...
<span class="name">[FundScreen.new](../views_after_auth_screens_funds_funds_screen/FundScreen/FundScreen.md)</span><span class="signature"></span>  
...
<span class="name">[createState](../views_after_auth_screens_funds_funds_screen/FundScreen/createState.md)</span><span class="signature"> <span class="returntype parameter">→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)<span class="signature">\<<span class="type-parameter">[FundScreen](../views_after_auth_screens_funds_funds_screen/FundScreen-class.md)</span>\></span></span> </span>  
