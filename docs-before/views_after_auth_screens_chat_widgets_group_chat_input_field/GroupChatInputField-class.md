...
<span class="name">[GroupChatInputField.new](../views_after_auth_screens_chat_widgets_group_chat_input_field/GroupChatInputField/GroupChatInputField.md)</span><span class="signature"></span>  
...
<span class="name">[createState](../views_after_auth_screens_chat_widgets_group_chat_input_field/GroupChatInputField/createState.md)</span><span class="signature"> <span class="returntype parameter">→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)<span class="signature">\<<span class="type-parameter">[GroupChatInputField](../views_after_auth_screens_chat_widgets_group_chat_input_field/GroupChatInputField-class.md)</span>\></span></span> </span>  
