...
# <span class="kind-method">isLastOccurenceOfWeekDay</span> static method
...
<span class="name">isLastOccurenceOfWeekDay</span>(

1.  <span id="isLastOccurenceOfWeekDay-param-date"
