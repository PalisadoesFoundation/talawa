  ...
  group('testing all tests', () {
    ...
    group('Edit Event Screen Widget Test', () {
      ...
      group("Testing body properties and contents", () {
        ...
        testWidgets("Testing Select Start Date and Time section",
            (tester) async {
          await tester.pumpWidget(
            editEventScreen(
              theme: TalawaTheme.lightTheme,
        ...
        testWidgets("Testing if cancel button in app bar works",
            (tester) async {
          await tester.pumpWidget(
            editEventScreen(
              theme: TalawaTheme.lightTheme,
          ...
          final createEventScreenPage =
              find.byKey(const Key('EditEventScreen'));
