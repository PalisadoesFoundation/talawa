...
@GenerateMocks(
  ...
  customMocks: [
    ...
    MockSpec<GraphqlConfig>(onMissingStub: null),
    MockSpec<PostService>(onMissingStub: null),
    MockSpec<MultiMediaPickerService>(onMissingStub: null),
    MockSpec<EventService>(onMissingStub: null),
    MockSpec<ChatService>(onMissingStub: null),
    MockSpec<UserConfig>(onMissingStub: null),
    MockSpec<AppLanguage>(onMissingStub: null),
    MockSpec<Connectivity>(onMissingStub: null),
    MockSpec<SignupDetailsViewModel>(onMissingStub: null),
    MockSpec<Post>(onMissingStub: null),
    MockSpec<DataBaseMutationFunctions>(onMissingStub: null),
    MockSpec<OrganizationService>(onMissingStub: null),
    MockSpec<ExploreEventsViewModel>(onMissingStub: null),
    MockSpec<Validator>(onMissingStub: null),
    MockSpec<QRViewController>(onMissingStub: null),
    MockSpec<CommentService>(onMissingStub: null),
    MockSpec<AppTheme>(onMissingStub: null),
    MockSpec<RequestViewModel>(onMissingStub: null),
