...
Event getTestEvent({
  ...
  return Event(
    ...
    isPublic: isPublic,
    startAt: DateTime.parse("2023-01-01 00:00:00"),
    endAt: DateTime.parse("2023-01-02 00:00:00"),
...
void main() {
  ...
  group("Widget Tests for VolunteerGroupscreen", () {
    ...
    testWidgets("Check if groups show up and add group works", (tester) async {
      final mockGroups = [
