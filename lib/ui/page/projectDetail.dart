...
import 'package:flutter_quito/ui/widgets/common_divider.dart';
...
class ProjectDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    menuItem = ModalRoute.of(context).settings.arguments;
