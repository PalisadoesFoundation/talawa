...
class WhatsappLogo extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path_0.arcToPoint(Offset(size.width * 0.7034000, size.height * 0.7677291),
        radius:
            Radius.elliptical(size.width * 0.3520000, size.height * 0.3505976),
        rotation: 0,
        largeArc: false,
        clockwise: true);
    path_0.arcToPoint(Offset(size.width * 0.5662000, size.height * 0.8264940),
        radius:
    ...
    path_1.arcToPoint(Offset(size.width * 0.5456000, size.height * 0.5876494),
        radius:
    ...
    path_1.arcToPoint(Offset(size.width * 0.5970000, size.height * 0.5428287),
        radius:
    ...
    path_1.arcToPoint(Offset(size.width * 0.7774000, size.height * 0.1699203),
        radius:
            Radius.elliptical(size.width * 0.4180000, size.height * 0.4163347),
        rotation: 0,
        largeArc: false,
        clockwise: true);
    path_1.arcToPoint(Offset(size.width * 0.9178000, size.height * 0.4368526),
        radius:
            Radius.elliptical(size.width * 0.4200000, size.height * 0.4183267),
        rotation: 0,
        largeArc: false,
        clockwise: true);
    path_1.arcToPoint(Offset(size.width * 0.8918000, size.height * 0.6380478),
        radius:
    ...
    path_1.arcToPoint(Offset(size.width * 0.5254000, size.height * 0.9039841),
        radius:
            Radius.elliptical(size.width * 0.4180000, size.height * 0.4163347),
        rotation: 0,
        largeArc: false,
        clockwise: true);
    path_1.arcToPoint(Offset(size.width * 0.2994000, size.height * 0.8541833),
        radius:
            Radius.elliptical(size.width * 0.4200000, size.height * 0.4183267),
        rotation: 0,
        largeArc: false,
    ...
    path_1.arcToPoint(Offset(size.width * 0.08240000, size.height * 0.4310757),
        radius:
            Radius.elliptical(size.width * 0.4200000, size.height * 0.4183267),
        rotation: 0,
        largeArc: false,
        clockwise: true);
    path_1.arcToPoint(Offset(size.width * 0.2574000, size.height * 0.1422311),
        radius:
    ...
    path_1.arcToPoint(Offset(size.width * 0.5654000, size.height * 0.8272908),
        radius:
            Radius.elliptical(size.width * 0.3500000, size.height * 0.3486056),
        rotation: 0,
        largeArc: false,
        clockwise: false);
    path_1.arcToPoint(Offset(size.width * 0.7026000, size.height * 0.7685259),
        radius:
            Radius.elliptical(size.width * 0.3460000, size.height * 0.3446215),
        rotation: 0,
        largeArc: false,
        clockwise: false);
    path_1.arcToPoint(Offset(size.width * 0.8352000, size.height * 0.5818725),
        radius:
            Radius.elliptical(size.width * 0.3520000, size.height * 0.3505976),
        rotation: 0,
        largeArc: false,
        clockwise: false);
    path_1.arcToPoint(Offset(size.width * 0.8300000, size.height * 0.3727092),
        radius:
            Radius.elliptical(size.width * 0.3500000, size.height * 0.3486056),
        rotation: 0,
        largeArc: false,
        clockwise: false);
    path_1.arcToPoint(Offset(size.width * 0.7252000, size.height * 0.2201195),
        radius:
            Radius.elliptical(size.width * 0.3500000, size.height * 0.3486056),
        rotation: 0,
        largeArc: false,
        clockwise: false);
    path_1.arcToPoint(Offset(size.width * 0.5470000, size.height * 0.1408367),
        radius:
