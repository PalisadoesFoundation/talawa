...
class _SplashScreenState extends State<SplashScreen> {
  ...
  /// Flutter supports deep linking on iOS, Android, and web browsers. Opening a URL displays that screen in your app. `_handleInitialUri` is an async function that is used to hanlde the initial uri of the application.
  ...
  /// Describes the part of the user interface represented by this widget. BuildContext is a locator that is used to track each widget in a tree and locate them and their position in the tree. 
  @override
