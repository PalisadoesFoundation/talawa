            ...
            _image == null
                ? const Padding(
                    ...
                    child: Text('Add Profile Image',
                        style: TextStyle(
                            fontSize: 16, color: UIData.primaryColor)),
                  )
                : IconButton(
                    icon: const Icon(
                      Icons.delete,
                ...
                children: <Widget>[
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      enabledBorder: OutlineInputBorder(
                        borderSide:
                            const BorderSide(color: UIData.primaryColor),
                      ...
                      prefixIcon:
                          const Icon(Icons.person, color: UIData.primaryColor),
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      prefixIcon:
                          const Icon(Icons.email, color: UIData.primaryColor),
                      labelText: "Email",
                      labelStyle: const TextStyle(color: UIData.primaryColor),
                      alignLabelWithHint: true,
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      prefixIcon:
                          const Icon(Icons.lock, color: UIData.primaryColor),
      ...
      child: GestureDetector(
        ...
        child: CircleAvatar(
          ...
          child: _image != null
              ...
              : CircleAvatar(
                  radius: 52,
                  backgroundColor: UIData.primaryColor.withOpacity(0.75),
                  child: Icon(
                    Icons.camera_alt,
