...
import 'package:talawa/view_model/after_auth_view_models/send_access_request/send_access_request_view_model.dart';
import 'package:talawa/views/base_view.dart';

/// Add Send Access Request View Model.
late SendAccessRequestViewModel model;
...
class SendAccessRequest extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: BaseView<SendAccessRequestViewModel>(
        onModelReady: (m) {
          m.initialise();
          model = m;
        },
