...
- **undoManager**: `MethodChannel`
  A JSON [MethodChannel] for handling undo events.

- **keyEvent**: `BasicMessageChannel<Object?>`
...
- **lifecycle**: `BasicMessageChannel<String?>`
...
- **system**: `BasicMessageChannel<Object?>`
...
- **accessibility**: `BasicMessageChannel<Object?>`
...
- **platform_views_2**: `MethodChannel`
  A [MethodChannel] for controlling platform views.
...
- **deferredComponent**: `MethodChannel`
  ...
  * `installDeferredComponent`: Requests that a deferred component identified by
    ...
    Calling `` on a deferred imported library is equivalent to calling
