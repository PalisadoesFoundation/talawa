...
# <span class="kind-method">editEvent</span> method
...
<span class="name">editEvent</span>(

1.  <span id="editEvent-param-eventId" class="parameter"></span>
...
- `variables`: this will be `map` type and contain all the event details
  need to be update.
