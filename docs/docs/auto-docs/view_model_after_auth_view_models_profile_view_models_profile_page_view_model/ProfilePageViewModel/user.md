...
# [user]{.kind-property} property

</div>

::: {.section .multi-line-signature}
[Box](https://pub.dev/documentation/hive/2.2.3/hive/Box-class.html)[\<[[User](../../models_user_user_info/User-class.html)]{.type-parameter}\>]{.signature}
[user]{.name}
