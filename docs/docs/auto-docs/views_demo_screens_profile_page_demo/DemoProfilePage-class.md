...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="views_demo_screens_profile_page_demo/views_demo_screens_profile_page_demo-library-sidebar.html" below-sidebar="views_demo_screens_profile_page_demo/DemoProfilePage-class-sidebar.html"}
<div>

# [DemoProfilePage]{.kind-class} class
...
[[homeModel](../views_demo_screens_profile_page_demo/DemoProfilePage/homeModel.html)]{.name} [→ [MainScreenViewModel](../view_model_main_screen_view_model/MainScreenViewModel-class.html)?]{.signature}
:   MainScreenViewModel.
    ::: features
    [final]{.feature}
    :::
...
[[build](../views_demo_screens_profile_page_demo/DemoProfilePage/build.html)]{.name}[([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)]{.type-annotation} [context]{.parameter-name}]{#build-param-context .parameter}) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)]{.returntype .parameter} ]{.signature}
...
[[guestViewWidget](../views_demo_screens_profile_page_demo/DemoProfilePage/guestViewWidget.html)]{.name}[([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)]{.type-annotation} [context]{.parameter-name}]{#guestViewWidget-param-context .parameter}) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)]{.returntype .parameter} ]{.signature}
