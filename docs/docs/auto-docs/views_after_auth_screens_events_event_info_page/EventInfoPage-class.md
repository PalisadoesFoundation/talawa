...
[EventInfoPage](../views_after_auth_screens_events_event_info_page/EventInfoPage/EventInfoPage.html)({[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)? key, required Map<String, dynamic> args})
...
[args](../views_after_auth_screens_events_event_info_page/EventInfoPage/args.html)
→ Map<String, dynamic>
...
[createState](../views_after_auth_screens_events_event_info_page/EventInfoPage/createState.html)()
→ \_EventInfoPageState
