...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="views_after_auth_screens_events_event_calendar/views_after_auth_screens_events_event_calendar-library-sidebar.html"}
<div>

# [views/after_auth_screens/events/event_calendar]{.kind-library} library
...
[[EventCalendar](../views_after_auth_screens_events_event_calendar/EventCalendar-class.html)]{.name}
...
[[parseTime](../views_after_auth_screens_events_event_calendar/parseTime.html)]{.name}[([[[String](https://api.flutter.dev/flutter/dart-core/String-class.html)]{.type-annotation} [time]{.parameter-name}]{#parseTime-param-time .parameter}) [→ [DateTime](https://api.flutter.dev/flutter/dart-core/DateTime-class.html)]{.returntype .parameter} ]{.signature}
