...
[[AddPost](../views_after_auth_screens_add_post_page/AddPost/AddPost.html)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?] key, ][[[GlobalKey](https://api.flutter.dev/flutter/widgets/GlobalKey-class.html)[\<[[ScaffoldState](https://api.flutter.dev/flutter/material/ScaffoldState-class.html)]\>]?] drawerKey]})]
...
[[drawerKey](../views_after_auth_screens_add_post_page/AddPost/drawerKey.html)] [→ [GlobalKey](https://api.flutter.dev/flutter/widgets/GlobalKey-class.html)[\<[[ScaffoldState](https://api.flutter.dev/flutter/material/ScaffoldState-class.html)]\>]?]
:   DrawerKey.
    ::: features
    final
    :::
...
[[createState](../views_after_auth_screens_add_post_page/AddPost/createState.html)][() [→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)[\<[[AddPost](../views_after_auth_screens_add_post_page/AddPost-class.html)]\>]] ]
