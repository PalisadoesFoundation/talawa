...
[[State](https://api.flutter.dev/flutter/widgets/State-class.html)[\<[[AddPost](../../views_after_auth_screens_add_post_page/AddPost-class.html)]{.type-parameter}\>]{.signature}]{.returntype}
[createState]{.name}()
