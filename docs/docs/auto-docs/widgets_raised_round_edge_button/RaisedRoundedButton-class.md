...
[[RaisedRoundedButton](../widgets_raised_round_edge_button/RaisedRoundedButton/RaisedRoundedButton.html)][({[required [[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)] key, ][required [[String](https://api.flutter.dev/flutter/dart-core/String-class.html)] buttonLabel, ][required [[Color](https://api.flutter.dev/flutter/painting/Color-class.html)] backgroundColor, ][required [[Color](https://api.flutter.dev/flutter/painting/Color-class.html)] textColor, ]required [dynamic , ][[[double](https://api.flutter.dev/flutter/dart-core/double-class.html)?] height, ][[[double](https://api.flutter.dev/flutter/dart-core/double-class.html)?] width, ][[[bool](https://api.flutter.dev/flutter/dart-core/bool-class.html)] showArrow = false]})]
...
[[backgroundColor](../widgets_raised_round_edge_button/RaisedRoundedButton/backgroundColor.html)] [→ [Color](https://api.flutter.dev/flutter/painting/Color-class.html)]

:   ::: features
    final
    :::

[[buttonLabel](../widgets_raised_round_edge_button/RaisedRoundedButton/buttonLabel.html)] [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)]
...
[[height](../widgets_raised_round_edge_button/RaisedRoundedButton/height.html)] [→ [double](https://api.flutter.dev/flutter/dart-core/double-class.html)?]
...
[[onTap](../widgets_raised_round_edge_button/RaisedRoundedButton/onTap.html)] → dynamic Function[()]
...
[[showArrow](../widgets_raised_round_edge_button/RaisedRoundedButton/showArrow.html)] [→ [bool](https://api.flutter.dev/flutter/dart-core/bool-class.html)]

:   ::: features
    final
    :::

[[textColor](../widgets_raised_round_edge_button/RaisedRoundedButton/textColor.html)] [→ [Color](https://api.flutter.dev/flutter/painting/Color-class.html)]

:   ::: features
    final
    :::

[[width](../widgets_raised_round_edge_button/RaisedRoundedButton/width.html)] [→ [double](https://api.flutter.dev/flutter/dart-core/double-class.html)?]
...
[createState](../widgets_raised_round_edge_button/RaisedRoundedButton/createState.html) [→ \_RaisedRoundedButtonState ]
