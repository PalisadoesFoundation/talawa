...
[RaisedRoundedButton](../widgets_raised_round_edge_button/RaisedRoundedButton/RaisedRoundedButton.html)({required [Key](https://api.flutter.dev/flutter/foundation/Key-class.html) key, required String buttonLabel, required [Color](https://api.flutter.dev/flutter/painting/Color-class.html) backgroundColor, required [Color](https://api.flutter.dev/flutter/painting/Color-class.html) textColor, required dynamic onTap(), double? height, double? width, bool showArrow = false})
...
[backgroundColor](../widgets_raised_round_edge_button/RaisedRoundedButton/backgroundColor.html)
→ [Color](https://api.flutter.dev/flutter/painting/Color-class.html)

final

[buttonLabel](../widgets_raised_round_edge_button/RaisedRoundedButton/buttonLabel.html)
→ String
...
[height](../widgets_raised_round_edge_button/RaisedRoundedButton/height.html)
→ double?
...
[onTap](../widgets_raised_round_edge_button/RaisedRoundedButton/onTap.html)
→ dynamic Function()
...
[showArrow](../widgets_raised_round_edge_button/RaisedRoundedButton/showArrow.html)
→ bool

final

[textColor](../widgets_raised_round_edge_button/RaisedRoundedButton/textColor.html)
→ [Color](https://api.flutter.dev/flutter/painting/Color-class.html)

final

[width](../widgets_raised_round_edge_button/RaisedRoundedButton/width.html)
→ double?
...
[createState](../widgets_raised_round_edge_button/RaisedRoundedButton/createState.html)()
