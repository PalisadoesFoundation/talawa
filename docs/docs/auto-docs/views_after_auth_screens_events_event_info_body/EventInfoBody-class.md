...
[[EventInfoBody](../views_after_auth_screens_events_event_info_body/EventInfoBody/EventInfoBody.html)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?] key]})]
...
[[build](../views_after_auth_screens_events_event_info_body/EventInfoBody/build.html)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
