...
[[EventInfoBody](../views_after_auth_screens_events_event_info_body/EventInfoBody/EventInfoBody.md)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.md)?] key]})]
