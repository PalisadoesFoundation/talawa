...
and
[key](../../views_after_auth_screens_events_event_info_body/EventInfoBody/key.md)
properties of the two widgets are
[operator==](../../views_after_auth_screens_events_event_info_body/EventInfoBody/operator_equals.md),
