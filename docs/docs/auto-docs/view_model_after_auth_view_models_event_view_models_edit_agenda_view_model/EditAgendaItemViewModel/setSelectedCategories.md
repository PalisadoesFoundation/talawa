...
# <span class="kind-method">setSelectedCategories</span> method
...
<span class="name">setSelectedCategories</span>(

1.  <span id="setSelectedCategories-param-categories"
    class="parameter"><span class="type-annotation">[List](https://api.flutter.dev/flutter/dart-core/List-class.md)<span class="signature">\<<span class="type-parameter">[AgendaCategory](../../models_events_event_agenda_category/AgendaCategory-class.md)</span>\></span></span>
