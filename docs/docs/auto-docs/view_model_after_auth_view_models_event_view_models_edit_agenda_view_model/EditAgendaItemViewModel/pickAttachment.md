...
# <span class="kind-method">pickAttachment</span> method
...
<span class="name">pickAttachment</span>(

1.  <span id="pickAttachment-param-fromCamera"
...
- `fromCamera`: If `true`, opens the camera to pick an image, otherwise
  opens the gallery.
