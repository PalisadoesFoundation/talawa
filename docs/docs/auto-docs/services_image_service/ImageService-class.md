...
above-sidebar="services_image_service/services_image_service-library-sidebar.html"
below-sidebar="services_image_service/ImageService-class-sidebar.html">

<div>

# <span class="kind-class">ImageService</span> class
...
<span class="name">[cropImage](../services_image_service/ImageService/cropImage.md)</span><span class="signature">(<span id="cropImage-param-imageFile" class="parameter"></span>) <span class="returntype parameter">→ [Future](https://api.flutter.dev/flutter/dart-async/Future-class.html)<span class="signature">\<<span class="type-parameter">[File](https://api.flutter.dev/flutter/dart-io/File-class.html)?</span>\></span></span> </span>  
