...
and
[key](../../widgets_signup_progress_indicator/SignupProgressIndicator/key.md)
properties of the two widgets are
[operator==](../../widgets_signup_progress_indicator/SignupProgressIndicator/operator_equals.md),
