...
[SignupProgressIndicator](../widgets_signup_progress_indicator/SignupProgressIndicator/SignupProgressIndicator.html)({required [Key](https://api.flutter.dev/flutter/foundation/Key-class.html) key, required int currentPageIndex})
...
[currentPageIndex](../widgets_signup_progress_indicator/SignupProgressIndicator/currentPageIndex.html)
→ int
...
[progressLabel](../widgets_signup_progress_indicator/SignupProgressIndicator/progressLabel.html)
→ List<String>
...
[build](../widgets_signup_progress_indicator/SignupProgressIndicator/build.html)([BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html) context)
→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)
