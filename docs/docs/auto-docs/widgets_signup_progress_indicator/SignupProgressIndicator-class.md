...
[[SignupProgressIndicator](../widgets_signup_progress_indicator/SignupProgressIndicator/SignupProgressIndicator.html)][({[required [[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)] key, ][required [[int](https://api.flutter.dev/flutter/dart-core/int-class.html)] currentPageIndex]})]
...
[[currentPageIndex](../widgets_signup_progress_indicator/SignupProgressIndicator/currentPageIndex.html)] [→ [int](https://api.flutter.dev/flutter/dart-core/int-class.html)]
...
[[progressLabel](../widgets_signup_progress_indicator/SignupProgressIndicator/progressLabel.html)] [→ [List](https://api.flutter.dev/flutter/dart-core/List-class.html)[\<[[String](https://api.flutter.dev/flutter/dart-core/String-class.html)]\>]]
...
[[build](../widgets_signup_progress_indicator/SignupProgressIndicator/build.html)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
