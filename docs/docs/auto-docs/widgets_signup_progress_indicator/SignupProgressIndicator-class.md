...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="widgets_signup_progress_indicator/widgets_signup_progress_indicator-library-sidebar.html" below-sidebar="widgets_signup_progress_indicator/SignupProgressIndicator-class-sidebar.html"}
<div>

# [SignupProgressIndicator]{.kind-class} class

</div>

::: {.section .desc .markdown}
This class returns a widget for showing the progress indicator/flow
while Signing Up/ Registration.
:::
...
[[SignupProgressIndicator](../widgets_signup_progress_indicator/SignupProgressIndicator/SignupProgressIndicator.html)]{.name}[({[required [[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)]{.type-annotation} [key]{.parameter-name}, ]{#-param-key .parameter}[required [[int](https://api.flutter.dev/flutter/dart-core/int-class.html)]{.type-annotation} [currentPageIndex]{.parameter-name}]{#-param-currentPageIndex .parameter}})]{.signature}
...
[[currentPageIndex](../widgets_signup_progress_indicator/SignupProgressIndicator/currentPageIndex.html)]{.name} [→ [int](https://api.flutter.dev/flutter/dart-core/int-class.html)]{.signature}
...
[[progressLabel](../widgets_signup_progress_indicator/SignupProgressIndicator/progressLabel.html)]{.name} [→ [List](https://api.flutter.dev/flutter/dart-core/List-class.html)[\<[[String](https://api.flutter.dev/flutter/dart-core/String-class.html)]{.type-parameter}\>]{.signature}]{.signature}
...
[[build](../widgets_signup_progress_indicator/SignupProgressIndicator/build.html)]{.name}[([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)]{.type-annotation} [context]{.parameter-name}]{#build-param-context .parameter}) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)]{.returntype .parameter} ]{.signature}
