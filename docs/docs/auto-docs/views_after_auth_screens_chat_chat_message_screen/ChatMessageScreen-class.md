...
<span class="name">[ChatMessageScreen.new](../views_after_auth_screens_chat_chat_message_screen/ChatMessageScreen/ChatMessageScreen.md)</span><span class="signature"></span>  
...
<span class="name">[createState](../views_after_auth_screens_chat_chat_message_screen/ChatMessageScreen/createState.md)</span><span class="signature"> <span class="returntype parameter">→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)<span class="signature">\<<span class="type-parameter">[ChatMessageScreen](../views_after_auth_screens_chat_chat_message_screen/ChatMessageScreen-class.md)</span>\></span></span> </span>  
