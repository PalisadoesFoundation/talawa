...
# <span class="kind-method">setupNavigationItems</span> method
...
<span class="name">setupNavigationItems</span>(

1.  <span id="setupNavigationItems-param-context"
