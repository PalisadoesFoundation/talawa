...
below-sidebar="plugin_types/TalawaMobilePlugin-class-sidebar.html">

<div>

# <span class="kind-class">TalawaMobilePlugin</span> class <a href="https://dart.dev/language/class-modifiers#abstract"
...
<span class="name">[manifest](../plugin_types/TalawaMobilePlugin/manifest.md)</span> <span class="signature">→ [PluginManifest](../plugin_types/PluginManifest-class.md)</span>  
Plugin metadata.
