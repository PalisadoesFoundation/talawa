...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="models_comment_comment_model/models_comment_comment_model-library-sidebar.html"}
<div>

# [models/comment/comment_model]{.kind-library} library
...
[[Comment](../models_comment_comment_model/Comment-class.html)]{.name}
:   This class returns a Comment instance.

[[CommentAdapter](../models_comment_comment_model/CommentAdapter-class.html)]{.name}
