...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="services_caching_base_feed_manager/services_caching_base_feed_manager-library-sidebar.html"}
<div>

# [services/caching/base_feed_manager]{.kind-library} library
...
[[BaseFeedManager](../services_caching_base_feed_manager/BaseFeedManager-class.html)[\<[T]{.type-parameter}\>]{.signature}]{.name}
