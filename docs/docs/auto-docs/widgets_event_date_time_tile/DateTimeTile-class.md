...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="widgets_event_date_time_tile/widgets_event_date_time_tile-library-sidebar.html" below-sidebar="widgets_event_date_time_tile/DateTimeTile-class-sidebar.html"}
<div>

# [DateTimeTile]{.kind-class} class
...
[[DateTimeTile](../widgets_event_date_time_tile/DateTimeTile/DateTimeTile.html)]{.name}[({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?]{.type-annotation} [key]{.parameter-name}, ]{#-param-key .parameter}[required [[String](https://api.flutter.dev/flutter/dart-core/String-class.html)]{.type-annotation} [date]{.parameter-name}, ]{#-param-date .parameter}[required [[String](https://api.flutter.dev/flutter/dart-core/String-class.html)]{.type-annotation} [time]{.parameter-name}, ]{#-param-time .parameter}[required [dynamic]{.type-annotation} [setDate]{.parameter-name}(), ]{#-param-setDate .parameter}[required [dynamic]{.type-annotation} [setTime]{.parameter-name}(), ]{#-param-setTime .parameter}[required [[bool](https://api.flutter.dev/flutter/dart-core/bool-class.html)]{.type-annotation} [isAllDay]{.parameter-name}]{#-param-isAllDay .parameter}})]{.signature}
...
[[date](../widgets_event_date_time_tile/DateTimeTile/date.html)]{.name} [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)]{.signature}
...
[[isAllDay](../widgets_event_date_time_tile/DateTimeTile/isAllDay.html)]{.name} [→ [bool](https://api.flutter.dev/flutter/dart-core/bool-class.html)]{.signature}
...
[[setDate](../widgets_event_date_time_tile/DateTimeTile/setDate.html)]{.name} [→ dynamic Function[()]{.signature}]{.signature}
:   Function that sets the date.
    ::: features
    [final]{.feature}
    :::

[[setTime](../widgets_event_date_time_tile/DateTimeTile/setTime.html)]{.name} [→ dynamic Function[()]{.signature}]{.signature}
:   Function that sets the time.
    ::: features
    [final]{.feature}
    :::

[[time](../widgets_event_date_time_tile/DateTimeTile/time.html)]{.name} [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)]{.signature}
...
[[build](../widgets_event_date_time_tile/DateTimeTile/build.html)]{.name}[([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)]{.type-annotation} [context]{.parameter-name}]{#build-param-context .parameter}) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)]{.returntype .parameter} ]{.signature}
