...
# <span class="kind-property">widget</span> property
...
<span class="returntype">[ManageMembersDialog](../../views_after_auth_screens_chat_widgets_manage_members_dialog/ManageMembersDialog-class.md)</span>
...
If the parent updates this location in the tree to a new widget with the
same
[runtimeType](https://api.flutter.dev/flutter/dart-core/Object/runtimeType.html)
and `Widget.key` as the current configuration, the framework will update
this property to refer to the new widget and then call
