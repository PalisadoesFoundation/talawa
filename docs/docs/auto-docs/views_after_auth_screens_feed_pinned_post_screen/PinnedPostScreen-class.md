...
<span class="name">[createState](../views_after_auth_screens_feed_pinned_post_screen/PinnedPostScreen/createState.md)</span><span class="signature"> <span class="returntype parameter">→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)<span class="signature">\<<span class="type-parameter">[PinnedPostScreen](../views_after_auth_screens_feed_pinned_post_screen/PinnedPostScreen-class.md)</span>\></span></span> </span>  
