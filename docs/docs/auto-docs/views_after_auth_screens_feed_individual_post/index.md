:::::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="views_after_auth_screens_feed_individual_post/views_after_auth_screens_feed_individual_post-library-sidebar.html"}
<div>

# [views\\after_auth_screens\\feed\\individual_post]{.kind-library} library
...
[[CommentTemplate](../views_after_auth_screens_feed_individual_post/CommentTemplate-class.html)]{.name}
:   CommentTemplate returns a widget of the individual user commented on
    the post.

[[IndividualPageLikeSection](../views_after_auth_screens_feed_individual_post/IndividualPageLikeSection-class.html)]{.name}
:   IndividualPageLikeSection returns a widget that show the list of all
    the users liked the post.

[[IndividualPostCommentSection](../views_after_auth_screens_feed_individual_post/IndividualPostCommentSection-class.html)]{.name}
:   Widget representing the comment section of an individual post.

[[IndividualPostView](../views_after_auth_screens_feed_individual_post/IndividualPostView-class.html)]{.name}
...
[[buildPadding](../views_after_auth_screens_feed_individual_post/buildPadding.html)]{.name}[([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)]{.type-annotation} [context]{.parameter-name}, ]{#buildPadding-param-context .parameter}[[[String](https://api.flutter.dev/flutter/dart-core/String-class.html)]{.type-annotation} [text]{.parameter-name}]{#buildPadding-param-text .parameter}) [→ [Padding](https://api.flutter.dev/flutter/widgets/Padding-class.html)]{.returntype .parameter} ]{.signature}
:   Generates a `Padding` widget with customizable vertical padding
    around a text element.

[[likedUserCircleAvatar](../views_after_auth_screens_feed_individual_post/likedUserCircleAvatar.html)]{.name}[([[[LikedBy](../models_post_post_model/LikedBy-class.html)]{.type-annotation} [user]{.parameter-name}]{#likedUserCircleAvatar-param-user .parameter}) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)]{.returntype .parameter} ]{.signature}
