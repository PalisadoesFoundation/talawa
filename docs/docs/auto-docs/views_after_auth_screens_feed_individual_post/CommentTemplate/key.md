...
and
[key](../../views_after_auth_screens_feed_individual_post/CommentTemplate/key.md)
properties of the two widgets are
[operator==](../../views_after_auth_screens_feed_individual_post/CommentTemplate/operator_equals.md),
