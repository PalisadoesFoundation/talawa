...
[[CommentTemplate](../views_after_auth_screens_feed_individual_post/CommentTemplate/CommentTemplate.html)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?] key, ][required [[Comment](../models_comment_comment_model/Comment-class.html)] comment]})]
...
[[comment](../views_after_auth_screens_feed_individual_post/CommentTemplate/comment.html)] [→ [Comment](../models_comment_comment_model/Comment-class.html)]
:   Instance of comment.
    ::: features
    final
    :::
...
[[build](../views_after_auth_screens_feed_individual_post/CommentTemplate/build.html)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
