...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="views_after_auth_screens_feed_individual_post/views_after_auth_screens_feed_individual_post-library-sidebar.html" below-sidebar="views_after_auth_screens_feed_individual_post/CommentTemplate-class-sidebar.html"}
<div>

# [CommentTemplate]{.kind-class} class
...
[[CommentTemplate](../views_after_auth_screens_feed_individual_post/CommentTemplate/CommentTemplate.html)]{.name}[({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?]{.type-annotation} [key]{.parameter-name}, ]{#-param-key .parameter}[required [[Comment](../models_comment_comment_model/Comment-class.html)]{.type-annotation} [comment]{.parameter-name}]{#-param-comment .parameter}})]{.signature}
...
[[comment](../views_after_auth_screens_feed_individual_post/CommentTemplate/comment.html)]{.name} [→ [Comment](../models_comment_comment_model/Comment-class.html)]{.signature}
:   Instance of comment.
    ::: features
    [final]{.feature}
    :::
