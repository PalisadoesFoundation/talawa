...
[IndividualPostCommentSection](../views_after_auth_screens_feed_individual_post/IndividualPostCommentSection/IndividualPostCommentSection.html)({[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)? key, required List<[Comments](../models_post_post_model/Comments-class.html)> comments, required String postID})
...
[comments](../views_after_auth_screens_feed_individual_post/IndividualPostCommentSection/comments.html)
...
[postID](../views_after_auth_screens_feed_individual_post/IndividualPostCommentSection/postID.html)
→ String
...
[build](../views_after_auth_screens_feed_individual_post/IndividualPostCommentSection/build.html)([BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html) context)
→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)
