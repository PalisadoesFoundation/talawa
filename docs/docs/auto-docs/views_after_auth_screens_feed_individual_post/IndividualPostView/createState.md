...
later inserted into the tree again, the framework will call [createState](../../views_after_auth_screens_feed_individual_post/IndividualPostView/createState.html)
