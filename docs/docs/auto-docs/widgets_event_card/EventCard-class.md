...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="widgets_event_card/widgets_event_card-library-sidebar.html" below-sidebar="widgets_event_card/EventCard-class-sidebar.html"}
<div>

# [EventCard]{.kind-class} class
...
[[EventCard](../widgets_event_card/EventCard/EventCard.html)]{.name}[({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?]{.type-annotation} [key]{.parameter-name}, ]{#-param-key .parameter}[required [[Event](../models_events_event_model/Event-class.html)]{.type-annotation} [event]{.parameter-name}, ]{#-param-event .parameter}[[[String](https://api.flutter.dev/flutter/dart-core/String-class.html)?]{.type-annotation} [eventTitleHighlightedText]{.parameter-name}, ]{#-param-eventTitleHighlightedText .parameter}[[[String](https://api.flutter.dev/flutter/dart-core/String-class.html)?]{.type-annotation} [eventTitleNormalText]{.parameter-name}, ]{#-param-eventTitleNormalText .parameter}[required [[bool](https://api.flutter.dev/flutter/dart-core/bool-class.html)]{.type-annotation} [isSearchItem]{.parameter-name}]{#-param-isSearchItem .parameter}})]{.signature}
...
[[event](../widgets_event_card/EventCard/event.html)]{.name} [→ [Event](../models_events_event_model/Event-class.html)]{.signature}
:   instance of an event.
    ::: features
    [final]{.feature}
    :::

[[eventTitleHighlightedText](../widgets_event_card/EventCard/eventTitleHighlightedText.html)]{.name} [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)?]{.signature}
:   Highlighted text of the event.
    ::: features
    [final]{.feature}
    :::

[[eventTitleNormalText](../widgets_event_card/EventCard/eventTitleNormalText.html)]{.name} [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)?]{.signature}
...
[[isSearchItem](../widgets_event_card/EventCard/isSearchItem.html)]{.name} [→ [bool](https://api.flutter.dev/flutter/dart-core/bool-class.html)]{.signature}
...
[[build](../widgets_event_card/EventCard/build.html)]{.name}[([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)]{.type-annotation} [context]{.parameter-name}]{#build-param-context .parameter}) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)]{.returntype .parameter} ]{.signature}
