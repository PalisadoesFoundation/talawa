...
build method - EventCard class - event\_card library - Dart API
...
If a widget's [build](../../widgets_event_card/EventCard/build.html) method is to depend on anything else, use a
