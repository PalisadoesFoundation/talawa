...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="widgets_event_card/widgets_event_card-library-sidebar.html"}
<div>

# [widgets/event_card]{.kind-library} library
...
[[EventCard](../widgets_event_card/EventCard-class.html)]{.name}
