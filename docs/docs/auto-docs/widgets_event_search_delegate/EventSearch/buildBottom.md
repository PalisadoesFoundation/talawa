...
# <span class="kind-method">buildBottom</span> method

</div>

<div class="section multi-line-signature">

<span class="returntype">PreferredSizeWidget?</span>
<span class="name">buildBottom</span>(

1.  <span id="buildBottom-param-context"
