...
# <span class="kind-method">buildFlexibleSpace</span> method
...
<span class="name">buildFlexibleSpace</span>(

1.  <span id="buildFlexibleSpace-param-context"
...
- `AppBar.flexibleSpace`, the intended use for the return value of this
  method.
