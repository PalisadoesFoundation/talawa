...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="widgets_post_widget/widgets_post_widget-library-sidebar.html" below-sidebar="widgets_post_widget/NewsPost-class-sidebar.html"}
<div>

# [NewsPost]{.kind-class} class
...
[[NewsPost](../widgets_post_widget/NewsPost/NewsPost.html)]{.name}[({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?]{.type-annotation} [key]{.parameter-name}, ]{#-param-key .parameter}[required [[Post](../models_post_post_model/Post-class.html)]{.type-annotation} [post]{.parameter-name}, ]{#-param-post .parameter}[[dynamic]{.type-annotation} [function]{.parameter-name}([[[Post](../models_post_post_model/Post-class.html)]{.type-annotation}]{#param- .parameter})?, ]{#-param-function .parameter}[[dynamic]{.type-annotation} [deletePost]{.parameter-name}([[[Post](../models_post_post_model/Post-class.html)]{.type-annotation}]{#param- .parameter})?]{#-param-deletePost .parameter}})]{.signature}
...
[[deletePost](../widgets_post_widget/NewsPost/deletePost.html)]{.name} [→ dynamic Function[([[[Post](../models_post_post_model/Post-class.html)]{.type-annotation}]{#param- .parameter})]{.signature}?]{.signature}
...
[[function](../widgets_post_widget/NewsPost/function.html)]{.name} [→ dynamic Function[([[[Post](../models_post_post_model/Post-class.html)]{.type-annotation}]{#param- .parameter})]{.signature}?]{.signature}
...
[[post](../widgets_post_widget/NewsPost/post.html)]{.name} [→ [Post](../models_post_post_model/Post-class.html)]{.signature}
...
[[build](../widgets_post_widget/NewsPost/build.html)]{.name}[([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)]{.type-annotation} [context]{.parameter-name}]{#build-param-context .parameter}) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)]{.returntype .parameter} ]{.signature}
