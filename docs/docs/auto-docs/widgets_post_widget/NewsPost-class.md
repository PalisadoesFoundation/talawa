...
[[NewsPost](../widgets_post_widget/NewsPost/NewsPost.md)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.md)?] key, ][required [[Post](../models_post_post_model/Post-class.md)] post, ][dynamic function([[[Post](../models_post_post_model/Post-class.md)]])?, ][dynamic deletePost([[[Post](../models_post_post_model/Post-class.md)]])?]})]
...
[[deletePost](../widgets_post_widget/NewsPost/deletePost.md)] [→ dynamic Function[([[[Post](../models_post_post_model/Post-class.md)]])]?]
...
[[build](../widgets_post_widget/NewsPost/build.md)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.md)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
