...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="generated_plugin_registrant/generated_plugin_registrant-library-sidebar.html"}
<div>

# [generated_plugin_registrant]{.kind-library} library
...
[[registerPlugins](../generated_plugin_registrant/registerPlugins.html)]{.name}[([[[Registrar](https://api.flutter.dev/flutter/flutter_web_plugins/Registrar-class.html)]{.type-annotation} [registrar]{.parameter-name}]{#registerPlugins-param-registrar .parameter}) [→ void]{.returntype .parameter} ]{.signature}
