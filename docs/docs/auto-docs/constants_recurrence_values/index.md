...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="constants_recurrence_values/constants_recurrence_values-library-sidebar.html"}
<div>

# [constants/recurrence_values]{.kind-library} library
...
[[EventEndTypes](../constants_recurrence_values/EventEndTypes-class.html)]{.name}
:   Class containing constants for event end types.

[[EventIntervals](../constants_recurrence_values/EventIntervals-class.html)]{.name}
:   Class containing constants for event intervals.

[[Frequency](../constants_recurrence_values/Frequency-class.html)]{.name}
:   Class containing constants for frequency options.

[[RecurrenceUtils](../constants_recurrence_values/RecurrenceUtils-class.html)]{.name}
:   conatins all neccessary utils.

[[RecurringEventMutationType](../constants_recurrence_values/RecurringEventMutationType-class.html)]{.name}
:   Class containing constants for recurrence end types.

[[WeekDays](../constants_recurrence_values/WeekDays-class.html)]{.name}
...
[[days](../constants_recurrence_values/days.html)]{.name} [↔ [List](https://api.flutter.dev/flutter/dart-core/List-class.html)[\<[[String](https://api.flutter.dev/flutter/dart-core/String-class.html)]{.type-parameter}\>]{.signature}]{.signature}
