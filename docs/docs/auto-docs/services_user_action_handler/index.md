...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="services_user_action_handler/services_user_action_handler-library-sidebar.html"}
<div>

# [services/user_action_handler]{.kind-library} library
...
[[ActionHandlerService](../services_user_action_handler/ActionHandlerService-class.html)]{.name}
