...
paint method - AppLogo class - talawa\_logo library - Dart API
...
[Canvas.clipRect](https://api.flutter.dev/flutter/painting/Canvas/clipRect.html) at the beginning of [paint](../../custom_painters_talawa_logo/AppLogo/paint.html) so everything that follows
...
3. In your delegate's [paint](../../custom_painters_talawa_logo/AppLogo/paint.html) method, call the [Canvas.drawImage](https://api.flutter.dev/flutter/painting/Canvas/drawImage.html),
