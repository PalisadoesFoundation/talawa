...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="custom_painters_talawa_logo/custom_painters_talawa_logo-library-sidebar.html"}
<div>

# [custom_painters/talawa_logo]{.kind-library} library
...
[[AppLogo](../custom_painters_talawa_logo/AppLogo-class.html)]{.name}
:   This class draws the app logo using custom paint. CustomPaint is a
    widget from the Flutter SDK, which enables you to use a canvas to
