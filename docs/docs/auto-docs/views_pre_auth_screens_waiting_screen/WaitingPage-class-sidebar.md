...
8.  [animate](https://pub.dev/documentation/flutter_animate/4.5.0/flutter_animate/AnimateWidgetExtensions/animate.html)
    ^(ext)^
9.  [build](views_pre_auth_screens_waiting_screen/WaitingPage/build.html)
...
19. [Operators](views_pre_auth_screens_waiting_screen/WaitingPage-class.html#operators)
20. [operator
