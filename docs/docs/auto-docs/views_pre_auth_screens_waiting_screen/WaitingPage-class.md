...
WaitingPage class - waiting\_screen library - Dart API
...
[WaitingPage](../views_pre_auth_screens_waiting_screen/WaitingPage/WaitingPage.html)({[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)? key})
...
[build](../views_pre_auth_screens_waiting_screen/WaitingPage/build.html)([BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html) context)
→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)
