:::::::::: {#dartdoc-main-content .main-content above-sidebar="views_pre_auth_screens_waiting_screen/views_pre_auth_screens_waiting_screen-library-sidebar.html" below-sidebar="views_pre_auth_screens_waiting_screen/WaitingPage-class-sidebar.html"}
<div>

# [WaitingPage]{.kind-class} class
...
[[WaitingPage](../views_pre_auth_screens_waiting_screen/WaitingPage/WaitingPage.html)]{.name}[({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?]{.type-annotation} [key]{.parameter-name}]{#-param-key .parameter}})]{.signature}
