...
[[CustomDrawer](../widgets_custom_drawer/CustomDrawer/CustomDrawer.html)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?] key, ][required [[MainScreenViewModel](../view_model_main_screen_view_model/MainScreenViewModel-class.html)] homeModel]})]
...
[[homeModel](../widgets_custom_drawer/CustomDrawer/homeModel.html)] [→ [MainScreenViewModel](../view_model_main_screen_view_model/MainScreenViewModel-class.html)]
:   home model.
    ::: features
    final
    :::
...
[[build](../widgets_custom_drawer/CustomDrawer/build.html)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
