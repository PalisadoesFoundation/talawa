...
below-sidebar="views_demo_page_view/DemoViewModel-class-sidebar.html">

<div>

# <span class="kind-class">DemoViewModel</span> class
...
<span class="name">[title](../views_demo_page_view/DemoViewModel/title.md)</span> <span class="signature">→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)</span>  
