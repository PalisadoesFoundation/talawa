...
4.  fetchAndSetUserVoteStatus method
...
# <span class="kind-method">fetchAndSetUserVoteStatus</span> method
...
<span class="name">fetchAndSetUserVoteStatus</span>(

1.  <span id="fetchAndSetUserVoteStatus-param-post"
