...
and [key](../../widgets_from_palisadoes/FromPalisadoes/key.md)
properties of the two widgets are
[operator==](../../widgets_from_palisadoes/FromPalisadoes/operator_equals.md),
...
[key](../../widgets_from_palisadoes/FromPalisadoes/key.md) allows the
