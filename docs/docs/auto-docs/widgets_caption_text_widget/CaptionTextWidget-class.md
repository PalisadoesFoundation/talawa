...
<span class="name">[createState](../widgets_caption_text_widget/CaptionTextWidget/createState.md)</span><span class="signature"> <span class="returntype parameter">→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)<span class="signature">\<<span class="type-parameter">[CaptionTextWidget](../widgets_caption_text_widget/CaptionTextWidget-class.md)</span>\></span></span> </span>  
