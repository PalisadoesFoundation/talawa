...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="widgets_custom_alert_dialog/widgets_custom_alert_dialog-library-sidebar.html" below-sidebar="widgets_custom_alert_dialog/CustomAlertDialog-class-sidebar.html"}
<div>

# [CustomAlertDialog]{.kind-class} class
...
[[dialogSubTitle](../widgets_custom_alert_dialog/CustomAlertDialog/dialogSubTitle.html)]{.name} [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)]{.signature}
:   Subtitle or message content of the dialog.
    ::: features
    [final]{.feature}
    :::

[[dialogTitle](../widgets_custom_alert_dialog/CustomAlertDialog/dialogTitle.html)]{.name} [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)]{.signature}
...
[[reverse](../widgets_custom_alert_dialog/CustomAlertDialog/reverse.html)]{.name} [→ [bool](https://api.flutter.dev/flutter/dart-core/bool-class.html)]{.signature}
...
[[secondaryButtonTap](../widgets_custom_alert_dialog/CustomAlertDialog/secondaryButtonTap.html)]{.name} [→ dynamic Function[()]{.signature}?]{.signature}
:   Function triggered upon tapping the secondary action button.
    ::: features
    [final]{.feature}
    :::

[[secondaryButtonText](../widgets_custom_alert_dialog/CustomAlertDialog/secondaryButtonText.html)]{.name} [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)]{.signature}
...
[[success](../widgets_custom_alert_dialog/CustomAlertDialog/success.html)]{.name} [→ dynamic Function[()]{.signature}]{.signature}
:   Function triggered upon tapping the primary action button.
    ::: features
    [final]{.feature}
    :::

[[successText](../widgets_custom_alert_dialog/CustomAlertDialog/successText.html)]{.name} [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)]{.signature}
...
[[build](../widgets_custom_alert_dialog/CustomAlertDialog/build.html)]{.name}[([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)]{.type-annotation} [context]{.parameter-name}]{#build-param-context .parameter}) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)]{.returntype .parameter} ]{.signature}
