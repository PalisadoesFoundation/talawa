...
and [key](../../widgets_custom_alert_dialog/CustomAlertDialog/key.md)
properties of the two widgets are
[operator==](../../widgets_custom_alert_dialog/CustomAlertDialog/operator_equals.md),
...
[key](../../widgets_custom_alert_dialog/CustomAlertDialog/key.md)
