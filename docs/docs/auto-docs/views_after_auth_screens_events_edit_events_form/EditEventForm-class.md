...
[[EditEventForm](../views_after_auth_screens_events_edit_events_form/EditEventForm/EditEventForm.html)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?] key, ][required [[EditEventViewModel](../view_model_after_auth_view_models_event_view_models_edit_event_view_model/EditEventViewModel-class.html)] model]})]
...
[[model](../views_after_auth_screens_events_edit_events_form/EditEventForm/model.html)] [→ [EditEventViewModel](../view_model_after_auth_view_models_event_view_models_edit_event_view_model/EditEventViewModel-class.html)]
...
[[build](../views_after_auth_screens_events_edit_events_form/EditEventForm/build.html)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
