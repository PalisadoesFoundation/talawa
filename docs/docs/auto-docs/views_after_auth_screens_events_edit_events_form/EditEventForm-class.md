...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="views_after_auth_screens_events_edit_events_form/views_after_auth_screens_events_edit_events_form-library-sidebar.html" below-sidebar="views_after_auth_screens_events_edit_events_form/EditEventForm-class-sidebar.html"}
<div>

# [EditEventForm]{.kind-class} class
...
[[EditEventForm](../views_after_auth_screens_events_edit_events_form/EditEventForm/EditEventForm.html)]{.name}[({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?]{.type-annotation} [key]{.parameter-name}, ]{#-param-key .parameter}[required [[EditEventViewModel](../view_model_after_auth_view_models_event_view_models_edit_event_view_model/EditEventViewModel-class.html)]{.type-annotation} [model]{.parameter-name}]{#-param-model .parameter}})]{.signature}
...
[[model](../views_after_auth_screens_events_edit_events_form/EditEventForm/model.html)]{.name} [→ [EditEventViewModel](../view_model_after_auth_view_models_event_view_models_edit_event_view_model/EditEventViewModel-class.html)]{.signature}
...
[[build](../views_after_auth_screens_events_edit_events_form/EditEventForm/build.html)]{.name}[([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)]{.type-annotation} [context]{.parameter-name}]{#build-param-context .parameter}) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)]{.returntype .parameter} ]{.signature}
