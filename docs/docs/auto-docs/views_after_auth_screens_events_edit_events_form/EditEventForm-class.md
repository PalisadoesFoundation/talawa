...
EditEventForm class - edit\_events\_form library - Dart API
...
[model](../views_after_auth_screens_events_edit_events_form/EditEventForm/model.html)
...
[build](../views_after_auth_screens_events_edit_events_form/EditEventForm/build.html)([BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html) context)
→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)
