...
# <span class="kind-method">setEventEndDate</span> method
...
<span class="name">setEventEndDate</span>(

1.  <span id="setEventEndDate-param-selectedEndDate"
    class="parameter"><span class="type-annotation">[DateTime](https://api.flutter.dev/flutter/dart-core/DateTime-class.md)</span>
    <span class="parameter-name">selectedEndDate</span></span>
