...
and [key](../../widgets_pledge_card/PledgeCard/key.md) properties of
the two widgets are
[operator==](../../widgets_pledge_card/PledgeCard/operator_equals.md),
...
[key](../../widgets_pledge_card/PledgeCard/key.md) allows the element
