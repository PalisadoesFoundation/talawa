...
and [key](../../widgets_rich_text/CustomRichText/key.md) properties of
the two widgets are
[operator==](../../widgets_rich_text/CustomRichText/operator_equals.md),
...
[key](../../widgets_rich_text/CustomRichText/key.md) allows the
