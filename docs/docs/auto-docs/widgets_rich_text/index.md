...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="widgets_rich_text/widgets_rich_text-library-sidebar.html"}
<div>

# [widgets/rich_text]{.kind-library} library
...
[[CustomRichText](../widgets_rich_text/CustomRichText-class.html)]{.name}
