...
[[State](https://api.flutter.dev/flutter/widgets/State-class.html)[\<[[UserEvents](../../views_after_auth_screens_profile_user_event/UserEvents-class.html)]{.type-parameter}\>]{.signature}]{.returntype}
[createState]{.name}()
