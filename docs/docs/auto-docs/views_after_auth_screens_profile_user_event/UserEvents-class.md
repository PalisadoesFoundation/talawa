...
[[UserEvents](../views_after_auth_screens_profile_user_event/UserEvents/UserEvents.html)][({[required [[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?] key]})]
...
[[createState](../views_after_auth_screens_profile_user_event/UserEvents/createState.html)][() [→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)[\<[[UserEvents](../views_after_auth_screens_profile_user_event/UserEvents-class.html)]\>]] ]
