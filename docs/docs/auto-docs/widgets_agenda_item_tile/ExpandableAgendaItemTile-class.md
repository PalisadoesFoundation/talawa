...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="widgets_agenda_item_tile/widgets_agenda_item_tile-library-sidebar.html" below-sidebar="widgets_agenda_item_tile/ExpandableAgendaItemTile-class-sidebar.html"}
<div>

# [ExpandableAgendaItemTile]{.kind-class} class
...
[[ExpandableAgendaItemTile](../widgets_agenda_item_tile/ExpandableAgendaItemTile/ExpandableAgendaItemTile.html)]{.name}[({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?]{.type-annotation} [key]{.parameter-name}, ]{#-param-key .parameter}[required [[EventAgendaItem](../models_events_event_agenda_item/EventAgendaItem-class.html)]{.type-annotation} [item]{.parameter-name}, ]{#-param-item .parameter}[required [[VoidCallback](https://api.flutter.dev/flutter/dart-ui/VoidCallback.html)]{.type-annotation} [onEdit]{.parameter-name}, ]{#-param-onEdit .parameter}[required [[VoidCallback](https://api.flutter.dev/flutter/dart-ui/VoidCallback.html)]{.type-annotation} [onDelete]{.parameter-name}]{#-param-onDelete .parameter}})]{.signature}
...
[[item](../widgets_agenda_item_tile/ExpandableAgendaItemTile/item.html)]{.name} [→ [EventAgendaItem](../models_events_event_agenda_item/EventAgendaItem-class.html)]{.signature}
...
[[onDelete](../widgets_agenda_item_tile/ExpandableAgendaItemTile/onDelete.html)]{.name} [→ [VoidCallback](https://api.flutter.dev/flutter/dart-ui/VoidCallback.html)]{.signature}
:   on delete callback for agenda item.
    ::: features
    [final]{.feature}
    :::

[[onEdit](../widgets_agenda_item_tile/ExpandableAgendaItemTile/onEdit.html)]{.name} [→ [VoidCallback](https://api.flutter.dev/flutter/dart-ui/VoidCallback.html)]{.signature}
...
[[build](../widgets_agenda_item_tile/ExpandableAgendaItemTile/build.html)]{.name}[([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)]{.type-annotation} [context]{.parameter-name}]{#build-param-context .parameter}) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)]{.returntype .parameter} ]{.signature}
