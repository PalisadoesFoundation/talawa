...
[[item](../widgets_agenda_item_tile/ExpandableAgendaItemTile/item.html)] [→ [EventAgendaItem](../models_events_event_agenda_item/EventAgendaItem-class.html)]
...
[[onDelete](../widgets_agenda_item_tile/ExpandableAgendaItemTile/onDelete.html)] [→ [VoidCallback](https://api.flutter.dev/flutter/dart-ui/VoidCallback.html)]
:   on delete callback for agenda item.
    ::: features
    final
    :::

[[onEdit](../widgets_agenda_item_tile/ExpandableAgendaItemTile/onEdit.html)] [→ [VoidCallback](https://api.flutter.dev/flutter/dart-ui/VoidCallback.html)]
...
[[build](../widgets_agenda_item_tile/ExpandableAgendaItemTile/build.html)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
