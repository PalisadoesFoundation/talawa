...
# <span class="kind-method">addVolunteerToGroup</span> method
...
<span class="name">addVolunteerToGroup</span>(

1.  <span id="addVolunteerToGroup-param-volunteerId"
    class="parameter"><span class="type-annotation">[String](https://api.flutter.dev/flutter/dart-core/String-class.md)</span>
    <span class="parameter-name">volunteerId</span>, </span>
2.  <span id="addVolunteerToGroup-param-eventId"
...
3.  <span id="addVolunteerToGroup-param-groupId"
    class="parameter"><span class="type-annotation">[String](https://api.flutter.dev/flutter/dart-core/String-class.html)</span>
    <span class="parameter-name">groupId</span></span>
