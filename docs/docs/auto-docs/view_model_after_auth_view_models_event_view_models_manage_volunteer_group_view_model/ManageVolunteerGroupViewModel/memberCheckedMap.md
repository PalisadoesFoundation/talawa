...
# [memberCheckedMap]{.kind-property} property
...
[[bool](https://api.flutter.dev/flutter/dart-core/bool-class.html)]{.type-parameter}\>]{.signature}]{.returntype}
get [memberCheckedMap]{.name}
:::
