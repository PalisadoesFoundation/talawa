...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="splash_screen/splash_screen-library-sidebar.html"}
<div>

# [splash_screen]{.kind-library} library
...
[[SplashScreen](../splash_screen/SplashScreen-class.html)]{.name}
