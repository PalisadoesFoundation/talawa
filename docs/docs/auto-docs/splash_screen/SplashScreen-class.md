...
[[SplashScreen](../splash_screen/SplashScreen/SplashScreen.html)][({[required [[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)] key, ][[[int](https://api.flutter.dev/flutter/dart-core/int-class.html)] mainScreenIndex = 0]})]
...
[[mainScreenIndex](../splash_screen/SplashScreen/mainScreenIndex.html)] [→ [int](https://api.flutter.dev/flutter/dart-core/int-class.html)]
...
[createState](../splash_screen/SplashScreen/createState.html) [→ \_SplashScreenState ]
