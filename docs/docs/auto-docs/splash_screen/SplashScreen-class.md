:::::::::: {#dartdoc-main-content .main-content above-sidebar="splash_screen/splash_screen-library-sidebar.html" below-sidebar="splash_screen/SplashScreen-class-sidebar.html"}
<div>

# [SplashScreen]{.kind-class} class
...
[[SplashScreen](../splash_screen/SplashScreen/SplashScreen.html)]{.name}[({[required [[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)]{.type-annotation} [key]{.parameter-name}, ]{#-param-key .parameter}[[[int](https://api.flutter.dev/flutter/dart-core/int-class.html)]{.type-annotation} [mainScreenIndex]{.parameter-name} = [0]{.default-value}]{#-param-mainScreenIndex .parameter}})]{.signature}
...
[[mainScreenIndex](../splash_screen/SplashScreen/mainScreenIndex.html)]{.name} [→ [int](https://api.flutter.dev/flutter/dart-core/int-class.html)]{.signature}
...
[[createState](../splash_screen/SplashScreen/createState.html)]{.name}[() [→ \_SplashScreenState]{.returntype .parameter} ]{.signature}
