...
[[SplashScreen](../splash_screen/SplashScreen/SplashScreen.md)][({[required [[Key](https://api.flutter.dev/flutter/foundation/Key-class.md)] key, ][[[int](https://api.flutter.dev/flutter/dart-core/int-class.html)] mainScreenIndex = 0]})]
