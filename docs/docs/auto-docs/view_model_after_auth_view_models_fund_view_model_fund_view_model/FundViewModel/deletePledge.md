...
# <span class="kind-method">deletePledge</span> method
...
<span class="name">deletePledge</span>(

1.  <span id="deletePledge-param-pledgeId"
    class="parameter"><span class="type-annotation">[String](https://api.flutter.dev/flutter/dart-core/String-class.md)</span>
    <span class="parameter-name">pledgeId</span>, </span>
2.  <span id="deletePledge-param-campaignId"
