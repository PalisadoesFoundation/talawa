...
# <span class="kind-method">sortCampaigns</span> method
...
<span class="name">sortCampaigns</span>(

1.  <span id="sortCampaigns-param-option"
    class="parameter"><span class="type-annotation">[String](https://api.flutter.dev/flutter/dart-core/String-class.md)</span>
    <span class="parameter-name">option</span></span>
