...
1. [talawa](../index.html)
2. [demo\_server\_data/events\_demo\_data.dart](../demo_server_data_events_demo_data/demo_server_data_events_demo_data-library.html)
...
1. [talawa](../index.html)
2. [events\_demo\_data](../demo_server_data_events_demo_data/demo_server_data_events_demo_data-library.html)
3. eventsDemoData constant
