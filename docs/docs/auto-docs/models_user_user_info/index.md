...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="models_user_user_info/models_user_user_info-library-sidebar.html"}
<div>

# [models/user/user_info]{.kind-library} library
...
[[User](../models_user_user_info/User-class.html)]{.name}
:   This class creates a User model and returns a user instance.

[[UserAdapter](../models_user_user_info/UserAdapter-class.html)]{.name}
