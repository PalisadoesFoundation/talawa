...
# <span class="kind-property">createdOrganizations</span> property
...
1.  @[HiveField](https://pub.dev/documentation/hive/2.2.3/hive/HiveField/HiveField.html)(8)
...
<span class="name">createdOrganizations</span>
