...
==](../../models_user_user_info/User/operator_equals.md) comparisons.
...
[operator ==](../../models_user_user_info/User/operator_equals.md)
...
If [operator ==](../../models_user_user_info/User/operator_equals.md)
...
==](../../models_user_user_info/User/operator_equals.md). The hash
...
[hashCode](../../models_user_user_info/User/hashCode.md), it should
override the [operator
==](../../models_user_user_info/User/operator_equals.md) operator as
