...
2.  [new](./OrganizationSearchList/OrganizationSearchList.md)
...
11. [createState](./OrganizationSearchList/createState.md)
...
20. [Operators](./OrganizationSearchList-class#operators.md)
21. [operator
