...
# <span class="kind-method">collectMenuItems</span> method
...
<span class="name">collectMenuItems</span>(

1.  <span id="collectMenuItems-param-context"
