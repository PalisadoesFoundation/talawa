...
and
[key](../../views_demo_screens_explore_events_demo/DemoExploreEvents/key.md)
properties of the two widgets are
[operator==](../../views_demo_screens_explore_events_demo/DemoExploreEvents/operator_equals.md),
