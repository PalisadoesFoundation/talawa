...
[[DemoExploreEvents](../views_demo_screens_explore_events_demo/DemoExploreEvents/DemoExploreEvents.md)][({[required [[Key](https://api.flutter.dev/flutter/foundation/Key-class.md)] key, ][[[MainScreenViewModel](../view_model_main_screen_view_model/MainScreenViewModel-class.md)?] homeModel]})]
