...
[[DemoExploreEvents](../views_demo_screens_explore_events_demo/DemoExploreEvents/DemoExploreEvents.html)][({[required [[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)] key, ][[[MainScreenViewModel](../view_model_main_screen_view_model/MainScreenViewModel-class.html)?] homeModel]})]
...
[[homeModel](../views_demo_screens_explore_events_demo/DemoExploreEvents/homeModel.html)] [→ [MainScreenViewModel](../view_model_main_screen_view_model/MainScreenViewModel-class.html)?]
...
[[build](../views_demo_screens_explore_events_demo/DemoExploreEvents/build.html)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
