...
# <span class="kind-method">showTalawaErrorSnackBar</span> method
...
<span class="name">showTalawaErrorSnackBar</span>(

1.  <span id="showTalawaErrorSnackBar-param-errorMessage"
...
2.  <span id="showTalawaErrorSnackBar-param-messageType"
    class="parameter"><span class="type-annotation">[MessageType](../../enums_enums/MessageType.md)</span>
    <span class="parameter-name">messageType</span></span>
