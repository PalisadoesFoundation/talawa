...
and [key](../../widgets_member_name_tile/MemberNameTile/key.md)
properties of the two widgets are
[operator==](../../widgets_member_name_tile/MemberNameTile/operator_equals.md),
...
[key](../../widgets_member_name_tile/MemberNameTile/key.md) allows the
