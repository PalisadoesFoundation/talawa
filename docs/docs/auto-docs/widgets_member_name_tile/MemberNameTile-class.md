:::::::::: {#dartdoc-main-content .main-content above-sidebar="widgets_member_name_tile/widgets_member_name_tile-library-sidebar.html" below-sidebar="widgets_member_name_tile/MemberNameTile-class-sidebar.html"}
<div>

# [MemberNameTile]{.kind-class} class
...
[[MemberNameTile](../widgets_member_name_tile/MemberNameTile/MemberNameTile.html)]{.name}[({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?]{.type-annotation} [key]{.parameter-name}, ]{#-param-key .parameter}[required [[String](https://api.flutter.dev/flutter/dart-core/String-class.html)]{.type-annotation} [userName]{.parameter-name}, ]{#-param-userName .parameter}[[[String](https://api.flutter.dev/flutter/dart-core/String-class.html)?]{.type-annotation} [userImage]{.parameter-name}, ]{#-param-userImage .parameter}[required [dynamic]{.type-annotation} [onDelete]{.parameter-name}()]{#-param-onDelete .parameter}})]{.signature}
...
[[onDelete](../widgets_member_name_tile/MemberNameTile/onDelete.html)]{.name} [→ dynamic Function[()]{.signature}]{.signature}
...
[[userImage](../widgets_member_name_tile/MemberNameTile/userImage.html)]{.name} [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)?]{.signature}
:   Represents the URL or path to the user\'s image.
    ::: features
    [final]{.feature}
    :::

[[userName](../widgets_member_name_tile/MemberNameTile/userName.html)]{.name} [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)]{.signature}
...
[[build](../widgets_member_name_tile/MemberNameTile/build.html)]{.name}[([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)]{.type-annotation} [context]{.parameter-name}]{#build-param-context .parameter}) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)]{.returntype .parameter} ]{.signature}
