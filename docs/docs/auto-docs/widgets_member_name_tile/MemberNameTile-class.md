...
[MemberNameTile](../widgets_member_name_tile/MemberNameTile/MemberNameTile.html)({[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)? key, required String userName, String? userImage, required dynamic onDelete()})
...
[onDelete](../widgets_member_name_tile/MemberNameTile/onDelete.html)
→ dynamic Function()
...
[userImage](../widgets_member_name_tile/MemberNameTile/userImage.html)
→ String?

Represents the URL or path to the user's image.
final

[userName](../widgets_member_name_tile/MemberNameTile/userName.html)
→ String
...
[build](../widgets_member_name_tile/MemberNameTile/build.html)([BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html) context)
→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)
