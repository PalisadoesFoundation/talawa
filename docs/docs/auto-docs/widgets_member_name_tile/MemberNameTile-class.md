...
[[MemberNameTile](../widgets_member_name_tile/MemberNameTile/MemberNameTile.html)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?] key, ][required [[String](https://api.flutter.dev/flutter/dart-core/String-class.html)] userName, ][[[String](https://api.flutter.dev/flutter/dart-core/String-class.html)?] userImage, ]required [dynamic ]})]
...
[[onDelete](../widgets_member_name_tile/MemberNameTile/onDelete.html)] → dynamic Function[()]
...
[[userImage](../widgets_member_name_tile/MemberNameTile/userImage.html)] [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)?]
:   Represents the URL or path to the user\'s image.
    ::: features
    final
    :::

[[userName](../widgets_member_name_tile/MemberNameTile/userName.html)] [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)]
...
[[build](../widgets_member_name_tile/MemberNameTile/build.html)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
