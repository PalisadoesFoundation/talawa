...
# <span class="kind-method">viewChanged</span> method
...
<span class="name">viewChanged</span>(

1.  <span id="viewChanged-param-viewChangedDetails"
    class="parameter"><span class="type-annotation">[ViewChangedDetails](https://pub.dev/documentation/syncfusion_flutter_calendar/28.2.12/calendar/ViewChangedDetails-class.md)</span>
    <span class="parameter-name">viewChangedDetails</span></span>
