...
<span class="name">[createState](../views_after_auth_screens_feed_organization_feed/OrganizationFeed/createState.md)</span><span class="signature"> <span class="returntype parameter">→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)<span class="signature">\<<span class="type-parameter">[OrganizationFeed](../views_after_auth_screens_feed_organization_feed/OrganizationFeed-class.md)</span>\></span></span> </span>  
