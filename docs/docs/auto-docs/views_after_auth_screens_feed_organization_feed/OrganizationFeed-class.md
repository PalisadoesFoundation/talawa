:::::::::: {#dartdoc-main-content .main-content above-sidebar="views_after_auth_screens_feed_organization_feed/views_after_auth_screens_feed_organization_feed-library-sidebar.html" below-sidebar="views_after_auth_screens_feed_organization_feed/OrganizationFeed-class-sidebar.html"}
<div>

# [OrganizationFeed]{.kind-class} class
...
[[forTest](../views_after_auth_screens_feed_organization_feed/OrganizationFeed/forTest.html)]{.name} [→ [bool](https://api.flutter.dev/flutter/dart-core/bool-class.html)]{.signature}
...
[[homeModel](../views_after_auth_screens_feed_organization_feed/OrganizationFeed/homeModel.html)]{.name} [→ [MainScreenViewModel](../view_model_main_screen_view_model/MainScreenViewModel-class.html)?]{.signature}
:   MainScreenViewModel.
    ::: features
    [final]{.feature}
    :::
...
[[createState](../views_after_auth_screens_feed_organization_feed/OrganizationFeed/createState.html)]{.name}[() [→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)[\<[[OrganizationFeed](../views_after_auth_screens_feed_organization_feed/OrganizationFeed-class.html)]{.type-parameter}\>]{.signature}]{.returntype .parameter} ]{.signature}
