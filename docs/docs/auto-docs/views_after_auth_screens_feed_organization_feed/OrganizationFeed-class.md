...
[OrganizationFeed](../views_after_auth_screens_feed_organization_feed/OrganizationFeed/OrganizationFeed.html)({required [Key](https://api.flutter.dev/flutter/foundation/Key-class.html) key, [MainScreenViewModel](../view_model_main_screen_view_model/MainScreenViewModel-class.html)? homeModel, bool forTest = false})
...
[forTest](../views_after_auth_screens_feed_organization_feed/OrganizationFeed/forTest.html)
→ bool
...
[homeModel](../views_after_auth_screens_feed_organization_feed/OrganizationFeed/homeModel.html)
