...
[[State](https://api.flutter.dev/flutter/widgets/State-class.html)[\<[[OrganizationFeed](../../views_after_auth_screens_feed_organization_feed/OrganizationFeed-class.html)]{.type-parameter}\>]{.signature}]{.returntype}
[createState]{.name}()
