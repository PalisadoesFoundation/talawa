...
1. [Constructors](widgets_organization_list/OrganizationList-class.html#constructors)
2. [OrganizationList](widgets_organization_list/OrganizationList/OrganizationList.html)
3. [Properties](widgets_organization_list/OrganizationList-class.html#instance-properties)
...
6. [model](widgets_organization_list/OrganizationList/model.html)
7. [runtimeType](https://api.flutter.dev/flutter/foundation/Diagnosticable/runtimeType.html)
8. [Methods](widgets_organization_list/OrganizationList-class.html#instance-methods)
9. [build](widgets_organization_list/OrganizationList/build.html)
...
19. [Operators](widgets_organization_list/OrganizationList-class.html#operators)
