...
<span class="name">[theme](../view_model_theme_view_model/AppTheme/theme.md)</span> <span class="signature">→ ThemeData</span>  
...
<span class="name">[switchTheme](../view_model_theme_view_model/AppTheme/switchTheme.md)</span><span class="signature">(<span id="switchTheme-param-isOn" class="parameter"></span>) <span class="returntype parameter">→ void</span> </span>  
