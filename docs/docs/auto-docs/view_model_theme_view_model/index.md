...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="view_model_theme_view_model/view_model_theme_view_model-library-sidebar.html"}
<div>

# [view_model/theme_view_model]{.kind-library} library
...
[[AppTheme](../view_model_theme_view_model/AppTheme-class.html)]{.name}
