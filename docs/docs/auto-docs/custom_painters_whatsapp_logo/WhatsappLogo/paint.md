...
paint method - WhatsappLogo class - whatsapp\_logo library - Dart API
...
[Canvas.clipRect](https://api.flutter.dev/flutter/painting/Canvas/clipRect.html) at the beginning of [paint](../../custom_painters_whatsapp_logo/WhatsappLogo/paint.html) so everything that follows
...
3. In your delegate's [paint](../../custom_painters_whatsapp_logo/WhatsappLogo/paint.html) method, call the [Canvas.drawImage](https://api.flutter.dev/flutter/painting/Canvas/drawImage.html),
