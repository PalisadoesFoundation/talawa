...
and
[key](../../views_pre_auth_screens_select_organization/SelectOrganization/key.md)
properties of the two widgets are
[operator==](../../views_pre_auth_screens_select_organization/SelectOrganization/operator_equals.md),
