...
[[SelectOrganization](../views_pre_auth_screens_select_organization/SelectOrganization/SelectOrganization.md)][({[required [[Key](https://api.flutter.dev/flutter/foundation/Key-class.md)] key, ][required [[String](https://api.flutter.dev/flutter/dart-core/String-class.html)] selectedOrgId]})]
