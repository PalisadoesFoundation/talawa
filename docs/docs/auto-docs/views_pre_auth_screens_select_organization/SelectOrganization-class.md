...
[SelectOrganization](../views_pre_auth_screens_select_organization/SelectOrganization/SelectOrganization.html)({required [Key](https://api.flutter.dev/flutter/foundation/Key-class.html) key, required String selectedOrgId})
...
[selectedOrgId](../views_pre_auth_screens_select_organization/SelectOrganization/selectedOrgId.html)
→ String
...
[createState](../views_pre_auth_screens_select_organization/SelectOrganization/createState.html)()
