...
[[PinnedPost](../widgets_pinned_post/PinnedPost/PinnedPost.html)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?] key, ][required [[List](https://api.flutter.dev/flutter/dart-core/List-class.html)[\<[[Post](../models_post_post_model/Post-class.html)]\>]] pinnedPost, ][required [[MainScreenViewModel](../view_model_main_screen_view_model/MainScreenViewModel-class.html)] model]})]
...
[[model](../widgets_pinned_post/PinnedPost/model.html)] [→ [MainScreenViewModel](../view_model_main_screen_view_model/MainScreenViewModel-class.html)]
:   gives access mainScreenViewModel\'s attributes.
    ::: features
    final
    :::

[[pinnedPost](../widgets_pinned_post/PinnedPost/pinnedPost.html)] [→ [List](https://api.flutter.dev/flutter/dart-core/List-class.html)[\<[[Post](../models_post_post_model/Post-class.html)]\>]]
...
[[build](../widgets_pinned_post/PinnedPost/build.html)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
...
[[getTimeDifferenceInHours](../widgets_pinned_post/PinnedPost/getTimeDifferenceInHours.html)][([[[String](https://api.flutter.dev/flutter/dart-core/String-class.html)] createdAtString]) [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)] ]
