...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="widgets_pinned_post/widgets_pinned_post-library-sidebar.html" below-sidebar="widgets_pinned_post/PinnedPost-class-sidebar.html"}
<div>

# [PinnedPost]{.kind-class} class
...
[[PinnedPost](../widgets_pinned_post/PinnedPost/PinnedPost.html)]{.name}[({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?]{.type-annotation} [key]{.parameter-name}, ]{#-param-key .parameter}[required [[List](https://api.flutter.dev/flutter/dart-core/List-class.html)[\<[[Post](../models_post_post_model/Post-class.html)]{.type-parameter}\>]{.signature}]{.type-annotation} [pinnedPost]{.parameter-name}, ]{#-param-pinnedPost .parameter}[required [[MainScreenViewModel](../view_model_main_screen_view_model/MainScreenViewModel-class.html)]{.type-annotation} [model]{.parameter-name}]{#-param-model .parameter}})]{.signature}
...
[[model](../widgets_pinned_post/PinnedPost/model.html)]{.name} [→ [MainScreenViewModel](../view_model_main_screen_view_model/MainScreenViewModel-class.html)]{.signature}
:   gives access mainScreenViewModel\'s attributes.
    ::: features
    [final]{.feature}
    :::

[[pinnedPost](../widgets_pinned_post/PinnedPost/pinnedPost.html)]{.name} [→ [List](https://api.flutter.dev/flutter/dart-core/List-class.html)[\<[[Post](../models_post_post_model/Post-class.html)]{.type-parameter}\>]{.signature}]{.signature}
...
[[build](../widgets_pinned_post/PinnedPost/build.html)]{.name}[([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)]{.type-annotation} [context]{.parameter-name}]{#build-param-context .parameter}) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)]{.returntype .parameter} ]{.signature}
...
[[getTimeDifferenceInHours](../widgets_pinned_post/PinnedPost/getTimeDifferenceInHours.html)]{.name}[([[[String](https://api.flutter.dev/flutter/dart-core/String-class.html)]{.type-annotation} [createdAtString]{.parameter-name}]{#getTimeDifferenceInHours-param-createdAtString .parameter}) [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)]{.returntype .parameter} ]{.signature}
...
[[toMap](../widgets_pinned_post/PinnedPost/toMap.html)]{.name}[([[[int](https://api.flutter.dev/flutter/dart-core/int-class.html)]{.type-annotation} [index]{.parameter-name}]{#toMap-param-index .parameter}) [→ [Map](https://api.flutter.dev/flutter/dart-core/Map-class.html)[\<[[String](https://api.flutter.dev/flutter/dart-core/String-class.html)]{.type-parameter}, [[String](https://api.flutter.dev/flutter/dart-core/String-class.html)]{.type-parameter}\>]{.signature}]{.returntype .parameter} ]{.signature}
