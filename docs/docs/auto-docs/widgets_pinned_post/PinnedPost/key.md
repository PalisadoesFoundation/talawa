...
and [key](../../widgets_pinned_post/PinnedPost/key.md) properties of
the two widgets are
[operator==](../../widgets_pinned_post/PinnedPost/operator_equals.md),
...
[key](../../widgets_pinned_post/PinnedPost/key.md) allows the element
