...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="views_after_auth_screens_profile_edit_profile_page/views_after_auth_screens_profile_edit_profile_page-library-sidebar.html" below-sidebar="views_after_auth_screens_profile_edit_profile_page/EditProfilePage-class-sidebar.html"}
<div>

# [EditProfilePage]{.kind-class} class
...
[[EditProfilePage](../views_after_auth_screens_profile_edit_profile_page/EditProfilePage/EditProfilePage.html)]{.name}[({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?]{.type-annotation} [key]{.parameter-name}]{#-param-key .parameter}})]{.signature}
...
[[createState](../views_after_auth_screens_profile_edit_profile_page/EditProfilePage/createState.html)]{.name}[() [→ \_EditProfilePageState]{.returntype .parameter} ]{.signature}
