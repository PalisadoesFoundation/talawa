...
and [key](../../widgets_interaction/Interactions/key.md) properties of
the two widgets are
[operator==](../../widgets_interaction/Interactions/operator_equals.md),
...
[key](../../widgets_interaction/Interactions/key.md) allows the
