...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="utils_encryptor/utils_encryptor-library-sidebar.html"}
<div>

# [utils/encryptor]{.kind-library} library
...
[[Encryptor](../utils_encryptor/Encryptor-class.html)]{.name}
