...
4.  fetchChatMessagesByChatId method
...
# <span class="kind-method">fetchChatMessagesByChatId</span> method
...
<span class="name">fetchChatMessagesByChatId</span>
...
- `String`: The GraphQL query string for fetching chat details and
  messages
