...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="utils_chat_queries/utils_chat_queries-library-sidebar.html"}
<div>

# [utils/chat_queries]{.kind-library} library
...
[[ChatQueries](../utils_chat_queries/ChatQueries-class.html)]{.name}
