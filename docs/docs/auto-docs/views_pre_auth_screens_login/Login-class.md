:::::::::: {#dartdoc-main-content .main-content above-sidebar="views_pre_auth_screens_login/views_pre_auth_screens_login-library-sidebar.html" below-sidebar="views_pre_auth_screens_login/Login-class-sidebar.html"}
<div>

# [Login]{.kind-class} class
...
[[Login](../views_pre_auth_screens_login/Login/Login.html)]{.name}[({[required [[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)]{.type-annotation} [key]{.parameter-name}]{#-param-key .parameter}})]{.signature}
...
[[createState](../views_pre_auth_screens_login/Login/createState.html)]{.name}[() [→ \_LoginState]{.returntype .parameter} ]{.signature}
