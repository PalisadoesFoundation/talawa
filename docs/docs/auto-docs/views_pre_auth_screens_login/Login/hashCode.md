...
==](../../views_pre_auth_screens_login/Login/operator_equals.md)
comparisons.
...
If [operator
==](../../views_pre_auth_screens_login/Login/operator_equals.md) is
...
==](../../views_pre_auth_screens_login/Login/operator_equals.md). The
...
[hashCode](../../views_pre_auth_screens_login/Login/hashCode.md), it
