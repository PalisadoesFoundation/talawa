...
<span class="name">[createState](../views_after_auth_screens_chat_create_group_bottom_sheet/CreateGroupBottomSheet/createState.md)</span><span class="signature"> <span class="returntype parameter">→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)<span class="signature">\<<span class="type-parameter">[CreateGroupBottomSheet](../views_after_auth_screens_chat_create_group_bottom_sheet/CreateGroupBottomSheet-class.md)</span>\></span></span> </span>  
