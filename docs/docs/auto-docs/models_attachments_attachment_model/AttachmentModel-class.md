...
<span class="name">[AttachmentModel](../models_attachments_attachment_model/AttachmentModel/AttachmentModel.md)</span><span class="signature">(<span id="-param-name" class="parameter"></span>)</span>  
