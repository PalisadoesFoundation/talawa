...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="view_model_base_view_model/view_model_base_view_model-library-sidebar.html"}
<div>

# [view_model/base_view_model]{.kind-library} library
...
[[BaseModel](../view_model_base_view_model/BaseModel-class.html)]{.name}
