...
and [key](../../widgets_post_list_widget/PostListWidget/key.md)
properties of the two widgets are
[operator==](../../widgets_post_list_widget/PostListWidget/operator_equals.md),
...
[key](../../widgets_post_list_widget/PostListWidget/key.md) allows the
