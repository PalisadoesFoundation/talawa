...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="custom_painters_language_icon/custom_painters_language_icon-library-sidebar.html"}
<div>

# [custom_painters/language_icon]{.kind-library} library
...
[[LanguageIcon](../custom_painters_language_icon/LanguageIcon-class.html)]{.name}
:   This class draws the language icon using custom paint. CustomPaint
