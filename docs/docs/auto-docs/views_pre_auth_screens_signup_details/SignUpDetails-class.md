...
[[SignUpDetails](../views_pre_auth_screens_signup_details/SignUpDetails/SignUpDetails.md)][({[required [[Key](https://api.flutter.dev/flutter/foundation/Key-class.md)] key, ][[[OrgInfo](../models_organization_org_info/OrgInfo-class.md)?] selectedOrg]})]
