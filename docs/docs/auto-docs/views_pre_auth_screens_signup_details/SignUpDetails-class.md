...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="views_pre_auth_screens_signup_details/views_pre_auth_screens_signup_details-library-sidebar.html" below-sidebar="views_pre_auth_screens_signup_details/SignUpDetails-class-sidebar.html"}
<div>

# [SignUpDetails]{.kind-class} class
...
[[selectedOrg](../views_pre_auth_screens_signup_details/SignUpDetails/selectedOrg.html)]{.name} [→ [OrgInfo](../models_organization_org_info/OrgInfo-class.html)]{.signature}
...
[[createState](../views_pre_auth_screens_signup_details/SignUpDetails/createState.html)]{.name}[() [→ \_SignUpDetailsState]{.returntype .parameter} ]{.signature}
