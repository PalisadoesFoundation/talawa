...
[SignUpDetails](../views_pre_auth_screens_signup_details/SignUpDetails/SignUpDetails.html)({required [Key](https://api.flutter.dev/flutter/foundation/Key-class.html) key, required [OrgInfo](../models_organization_org_info/OrgInfo-class.html) selectedOrg})
...
[selectedOrg](../views_pre_auth_screens_signup_details/SignUpDetails/selectedOrg.html)
