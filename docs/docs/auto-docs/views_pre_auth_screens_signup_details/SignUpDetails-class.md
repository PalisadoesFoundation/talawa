...
[[SignUpDetails](../views_pre_auth_screens_signup_details/SignUpDetails/SignUpDetails.html)][({[required [[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)] key, ][[[OrgInfo](../models_organization_org_info/OrgInfo-class.html)?] selectedOrg]})]
...
[[selectedOrg](../views_pre_auth_screens_signup_details/SignUpDetails/selectedOrg.html)] [→ [OrgInfo](../models_organization_org_info/OrgInfo-class.html)?]
...
[createState](../views_pre_auth_screens_signup_details/SignUpDetails/createState.html) [→ \_SignUpDetailsState ]
