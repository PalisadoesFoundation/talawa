...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="views_main_screen/views_main_screen-library-sidebar.html" below-sidebar="views_main_screen/MainScreen-class-sidebar.html"}
<div>

# [MainScreen]{.kind-class} class
...
[[MainScreen](../views_main_screen/MainScreen/MainScreen.html)]{.name}[({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?]{.type-annotation} [key]{.parameter-name}, ]{#-param-key .parameter}[required [[MainScreenArgs](../models_mainscreen_navigation_args/MainScreenArgs-class.html)]{.type-annotation} [mainScreenArgs]{.parameter-name}]{#-param-mainScreenArgs .parameter}})]{.signature}
...
[[mainScreenArgs](../views_main_screen/MainScreen/mainScreenArgs.html)]{.name} [→ [MainScreenArgs](../models_mainscreen_navigation_args/MainScreenArgs-class.html)]{.signature}
...
[[createState](../views_main_screen/MainScreen/createState.html)]{.name}[() [→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)[\<[[MainScreen](../views_main_screen/MainScreen-class.html)]{.type-parameter}\>]{.signature}]{.returntype .parameter} ]{.signature}
