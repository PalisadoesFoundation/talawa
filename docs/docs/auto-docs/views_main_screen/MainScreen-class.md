...
[[MainScreen](../views_main_screen/MainScreen/MainScreen.html)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?] key, ][required [[MainScreenArgs](../models_mainscreen_navigation_args/MainScreenArgs-class.html)] mainScreenArgs]})]
...
[[mainScreenArgs](../views_main_screen/MainScreen/mainScreenArgs.html)] [→ [MainScreenArgs](../models_mainscreen_navigation_args/MainScreenArgs-class.html)]
...
[[createState](../views_main_screen/MainScreen/createState.html)][() [→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)[\<[[MainScreen](../views_main_screen/MainScreen-class.html)]\>]] ]
