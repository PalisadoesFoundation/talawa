...
<span class="name">[MainScreen.new](../views_main_screen/MainScreen/MainScreen.md)</span><span class="signature"></span>  
...
<span class="name">[createState](../views_main_screen/MainScreen/createState.md)</span><span class="signature"> <span class="returntype parameter">→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)<span class="signature">\<<span class="type-parameter">[MainScreen](../views_main_screen/MainScreen-class.md)</span>\></span></span> </span>  
