...
<span class="returntype">[State](https://api.flutter.dev/flutter/widgets/State-class.html)<span class="signature">\<<span class="type-parameter">[MainScreen](../../views_main_screen/MainScreen-class.md)</span>\></span></span>
