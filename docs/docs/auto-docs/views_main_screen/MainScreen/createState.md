...
<span class="returntype">State<span class="signature">\<<span class="type-parameter">[MainScreen](../../views_main_screen/MainScreen-class.md)</span>\></span></span>
...
[createState](../../views_main_screen/MainScreen/createState.md) again
to create a fresh `State` object, simplifying the lifecycle of `State`
objects.
