...
and
[key](../../views_demo_screens_organization_feed_demo/DemoOrganizationFeed/key.md)
properties of the two widgets are
[operator==](../../views_demo_screens_organization_feed_demo/DemoOrganizationFeed/operator_equals.md),
