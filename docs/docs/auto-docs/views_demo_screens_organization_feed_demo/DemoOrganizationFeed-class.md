...
<span class="name">[demoOrganisationFeedPage](../views_demo_screens_organization_feed_demo/DemoOrganizationFeed/demoOrganisationFeedPage.md)</span><span class="signature">(<span id="demoOrganisationFeedPage-param-context" class="parameter"><span class="type-annotation">[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.md)</span> <span class="parameter-name">context</span></span>) <span class="returntype parameter">→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)</span> </span>  
