...
above-sidebar="plugin_index/plugin_index-library-sidebar.html"
below-sidebar="">

<div>

# <span class="kind-function">buildPluginRoutes</span> function
...
- `Map<String, WidgetBuilder>`: A map of route names to their
  corresponding widget builders.
