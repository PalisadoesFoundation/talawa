...
<span class="name">[icon](../widgets_fund_build_info_row/FundBuildInfoRow/icon.md)</span> <span class="signature">→ [IconData](https://api.flutter.dev/flutter/widgets/IconData-class.html)</span>  
