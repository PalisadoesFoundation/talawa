...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="main/main-library-sidebar.html"}
<div>
...
[[DemoPageView](../main/DemoPageView-class.html)]{.name}
:   PageView is a scrollable list that works page by page.

[[DemoViewModel](../main/DemoViewModel-class.html)]{.name}
...
[[main](../main/main.html)]{.name}[() [→ [Future](https://api.flutter.dev/flutter/dart-core/Future-class.html)[\<[void]{.type-parameter}\>]{.signature}]{.returntype .parameter} ]{.signature}
