...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="main/main-library-sidebar.html" below-sidebar="main/DemoViewModel-class-sidebar.html"}
<div>

# [DemoViewModel]{.kind-class} class
...
[[DemoViewModel](../main/DemoViewModel/DemoViewModel.html)]{.name}[()]{.signature}
...
[[title](../main/DemoViewModel/title.html)]{.name} [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)]{.signature}
