:::::::::: {#dartdoc-main-content .main-content above-sidebar="main/main-library-sidebar.html" below-sidebar="main/MyApp-class-sidebar.html"}
<div>
...
[[MyApp](../main/MyApp/MyApp.html)]{.name}[()]{.signature}
...
[[createState](../main/MyApp/createState.html)]{.name}[() [→ \_MyAppState]{.returntype .parameter} ]{.signature}
