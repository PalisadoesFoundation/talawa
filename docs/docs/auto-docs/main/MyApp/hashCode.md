...
that affects [operator ==](../../main/MyApp/operator_equals.md)
comparisons.
...
[operator ==](../../main/MyApp/operator_equals.md) implementation only
considers objects equal if they are identical (see
[identityHashCode](https://api.flutter.dev/flutter/dart-core/identityHashCode.md)).

If [operator ==](../../main/MyApp/operator_equals.md) is overridden to
use the object state instead, the hash code must also be changed to
represent that state, otherwise the object cannot be used in hash based
data structures like the default
...
according to [operator ==](../../main/MyApp/operator_equals.md). The
...
If a subclass overrides [hashCode](../../main/MyApp/hashCode.md), it
should override the [operator ==](../../main/MyApp/operator_equals.md)
