...
<span class="name">[createState](../views_after_auth_screens_events_create_custom_recurring_event/CustomRecurrencePage/createState.md)</span><span class="signature"> <span class="returntype parameter">→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)<span class="signature">\<<span class="type-parameter">[CustomRecurrencePage](../views_after_auth_screens_events_create_custom_recurring_event/CustomRecurrencePage-class.md)</span>\></span></span> </span>  
