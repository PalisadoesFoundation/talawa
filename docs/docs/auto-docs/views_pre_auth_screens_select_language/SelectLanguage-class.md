:::::::::: {#dartdoc-main-content .main-content above-sidebar="views_pre_auth_screens_select_language/views_pre_auth_screens_select_language-library-sidebar.html" below-sidebar="views_pre_auth_screens_select_language/SelectLanguage-class-sidebar.html"}
<div>

# [SelectLanguage]{.kind-class} class
...
[[SelectLanguage](../views_pre_auth_screens_select_language/SelectLanguage/SelectLanguage.html)]{.name}[({[required [[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)]{.type-annotation} [key]{.parameter-name}]{#-param-key .parameter}})]{.signature}
...
[[createState](../views_pre_auth_screens_select_language/SelectLanguage/createState.html)]{.name}[() [→ \_SelectLanguageState]{.returntype .parameter} ]{.signature}
