...
[[createState](../views_after_auth_screens_events_create_event_page/CreateEventPage/createState.html)]{.name}[() [→ [CreateEventPageState](../views_after_auth_screens_events_create_event_page/CreateEventPageState-class.html)]{.returntype .parameter} ]{.signature}
