...
[[CreateEventPage](../views_after_auth_screens_events_create_event_page/CreateEventPage/CreateEventPage.html)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?] key]})]
...
[[createState](../views_after_auth_screens_events_create_event_page/CreateEventPage/createState.html)][() [→ [CreateEventPageState](../views_after_auth_screens_events_create_event_page/CreateEventPageState-class.html)] ]
