...
and
[key](../../views_after_auth_screens_events_create_event_page/CreateEventPage/key.md)
properties of the two widgets are
[operator==](../../views_after_auth_screens_events_create_event_page/CreateEventPage/operator_equals.md),
