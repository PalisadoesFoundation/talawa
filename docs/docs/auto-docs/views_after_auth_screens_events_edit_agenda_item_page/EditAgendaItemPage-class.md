...
[[EditAgendaItemPage](../views_after_auth_screens_events_edit_agenda_item_page/EditAgendaItemPage/EditAgendaItemPage.md)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.md)?] key, ][required [[EventAgendaItem](../models_events_event_agenda_item/EventAgendaItem-class.md)] agendaItem, ][required [[List](https://api.flutter.dev/flutter/dart-core/List-class.html)[\<[[AgendaCategory](../models_events_event_agenda_category/AgendaCategory-class.md)]\>]] categories]})]
