...
# <span class="kind-method">createChatWithUser</span> method
...
<span class="name">createChatWithUser</span>(

1.  <span id="createChatWithUser-param-selectedUser"
    class="parameter"><span class="type-annotation">[User](../../models_user_user_info/User-class.md)</span>
    <span class="parameter-name">selectedUser</span></span>
