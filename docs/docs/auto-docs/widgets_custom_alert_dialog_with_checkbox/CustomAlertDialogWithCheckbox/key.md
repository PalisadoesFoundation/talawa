...
and
[key](../../widgets_custom_alert_dialog_with_checkbox/CustomAlertDialogWithCheckbox/key.md)
properties of the two widgets are
[operator==](../../widgets_custom_alert_dialog_with_checkbox/CustomAlertDialogWithCheckbox/operator_equals.md),
