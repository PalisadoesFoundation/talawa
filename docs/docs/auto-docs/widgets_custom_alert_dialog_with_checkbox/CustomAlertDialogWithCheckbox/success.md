...
# [success]{.kind-property} property

</div>

::: {.section .multi-line-signature}
dynamic
Function[([[[bool](https://api.flutter.dev/flutter/dart-core/bool-class.html)?]{.type-annotation}]{#param-
.parameter})]{.signature} [success]{.name}
