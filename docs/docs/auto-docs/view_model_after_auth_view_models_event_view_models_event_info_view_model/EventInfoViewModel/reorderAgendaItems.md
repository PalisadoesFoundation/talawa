...
# <span class="kind-method">reorderAgendaItems</span> method
...
<span class="name">reorderAgendaItems</span>(

1.  <span id="reorderAgendaItems-param-oldIndex"
    class="parameter"><span class="type-annotation">[int](https://api.flutter.dev/flutter/dart-core/int-class.md)</span>
    <span class="parameter-name">oldIndex</span>, </span>
2.  <span id="reorderAgendaItems-param-newIndex"
    class="parameter"><span class="type-annotation">[int](https://api.flutter.dev/flutter/dart-core/int-class.html)</span>
    <span class="parameter-name">newIndex</span></span>
