...
[[createState](../views_after_auth_screens_events_create_agenda_item_page/CreateAgendaItemPage/createState.html)]{.name}[() [→ \_CreateAgendaItemPageState]{.returntype .parameter} ]{.signature}
