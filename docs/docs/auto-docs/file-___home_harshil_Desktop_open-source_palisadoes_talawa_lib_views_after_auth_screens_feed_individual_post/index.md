...
[CommentTemplate](../file-___home_harshil_Desktop_open-source_palisadoes_talawa_lib_views_after_auth_screens_feed_individual_post/CommentTemplate-class.html)

CommentTemplate returns a widget of the individual user commented on the post.

[IndividualPageLikeSection](../file-___home_harshil_Desktop_open-source_palisadoes_talawa_lib_views_after_auth_screens_feed_individual_post/IndividualPageLikeSection-class.html)

IndividualPageLikeSection returns a widget that show the list of all the users liked the post.

[IndividualPostCommentSection](../file-___home_harshil_Desktop_open-source_palisadoes_talawa_lib_views_after_auth_screens_feed_individual_post/IndividualPostCommentSection-class.html)

Widget representing the comment section of an individual post.

[IndividualPostView](../file-___home_harshil_Desktop_open-source_palisadoes_talawa_lib_views_after_auth_screens_feed_individual_post/IndividualPostView-class.html)
...
[buildPadding](../file-___home_harshil_Desktop_open-source_palisadoes_talawa_lib_views_after_auth_screens_feed_individual_post/buildPadding.html)(dynamic context, [String](https://api.flutter.dev/flutter/dart-core/String-class.html) text)
→ dynamic


Generates a `Padding` widget with customizable vertical padding around a text element.

[likedUserCircleAvatar](../file-___home_harshil_Desktop_open-source_palisadoes_talawa_lib_views_after_auth_screens_feed_individual_post/likedUserCircleAvatar.html)(dynamic user)
→ dynamic
