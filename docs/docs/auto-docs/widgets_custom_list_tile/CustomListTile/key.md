...
and [key](../../widgets_custom_list_tile/CustomListTile/key.md)
properties of the two widgets are
[operator==](../../widgets_custom_list_tile/CustomListTile/operator_equals.md),
...
[key](../../widgets_custom_list_tile/CustomListTile/key.md) allows the
