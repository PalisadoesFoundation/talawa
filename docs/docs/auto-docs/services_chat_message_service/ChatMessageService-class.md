...
<span class="name">[getChatDetails](../services_chat_message_service/ChatMessageService/getChatDetails.md)</span><span class="signature">(<span id="getChatDetails-param-chatId" class="parameter"><span class="type-annotation">[String](https://api.flutter.dev/flutter/dart-core/String-class.md)</span> <span class="parameter-name">chatId</span>, </span><span id="getChatDetails-param-isInitialLoad" class="parameter"></span>) <span class="returntype parameter">→ [Future](https://api.flutter.dev/flutter/dart-async/Future-class.html)<span class="signature">\<<span class="type-parameter">[Chat](../models_chats_chat/Chat-class.md)?</span>\></span></span> </span>  
