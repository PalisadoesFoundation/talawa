...
[[Message](../views_after_auth_screens_chat_widgets_chat_message_bubble/Message/Message.md)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.md)?] key, ][required [[ChatMessage](../models_chats_chat_message/ChatMessage-class.md)] message]})]
