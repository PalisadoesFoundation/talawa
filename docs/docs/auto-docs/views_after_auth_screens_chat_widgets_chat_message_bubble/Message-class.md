:::::::::: {#dartdoc-main-content .main-content above-sidebar="views_after_auth_screens_chat_widgets_chat_message_bubble/views_after_auth_screens_chat_widgets_chat_message_bubble-library-sidebar.html" below-sidebar="views_after_auth_screens_chat_widgets_chat_message_bubble/Message-class-sidebar.html"}
<div>

# [Message]{.kind-class} class
...
[[Message](../views_after_auth_screens_chat_widgets_chat_message_bubble/Message/Message.html)]{.name}[({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?]{.type-annotation} [key]{.parameter-name}, ]{#-param-key .parameter}[required [[ChatMessage](../models_chats_chat_message/ChatMessage-class.html)]{.type-annotation} [message]{.parameter-name}]{#-param-message .parameter}})]{.signature}
...
[[message](../views_after_auth_screens_chat_widgets_chat_message_bubble/Message/message.html)]{.name} [→ [ChatMessage](../models_chats_chat_message/ChatMessage-class.html)]{.signature}
...
[[build](../views_after_auth_screens_chat_widgets_chat_message_bubble/Message/build.html)]{.name}[([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)]{.type-annotation} [context]{.parameter-name}]{#build-param-context .parameter}) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)]{.returntype .parameter} ]{.signature}
