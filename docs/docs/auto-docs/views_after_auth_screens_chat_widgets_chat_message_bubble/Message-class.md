...
[[Message](../views_after_auth_screens_chat_widgets_chat_message_bubble/Message/Message.html)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?] key, ][required [[ChatMessage](../models_chats_chat_message/ChatMessage-class.html)] message]})]
...
[[message](../views_after_auth_screens_chat_widgets_chat_message_bubble/Message/message.html)] [→ [ChatMessage](../models_chats_chat_message/ChatMessage-class.html)]
...
[[build](../views_after_auth_screens_chat_widgets_chat_message_bubble/Message/build.html)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
