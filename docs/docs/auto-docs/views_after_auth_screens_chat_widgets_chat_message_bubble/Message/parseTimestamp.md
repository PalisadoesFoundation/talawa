...
# <span class="kind-method">parseTimestamp</span> method

</div>

<div class="section multi-line-signature">

<span class="returntype">[DateTime](https://api.flutter.dev/flutter/dart-core/DateTime-class.html)</span>
<span class="name">parseTimestamp</span>(

1.  <span id="parseTimestamp-param-timestamp"
    class="parameter"><span class="type-annotation">[String](https://api.flutter.dev/flutter/dart-core/String-class.md)</span>
    <span class="parameter-name">timestamp</span></span>
...
Attempts to parse the given timestamp string into a DateTime. If parsing
fails, returns the current time as a fallback.
