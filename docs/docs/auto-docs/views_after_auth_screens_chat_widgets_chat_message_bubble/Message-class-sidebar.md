...
1. [Constructors](views_after_auth_screens_chat_widgets_chat_message_bubble/Message-class.html#constructors)
2. [Message](views_after_auth_screens_chat_widgets_chat_message_bubble/Message/Message.html)
3. [Properties](views_after_auth_screens_chat_widgets_chat_message_bubble/Message-class.html#instance-properties)
...
6. [message](views_after_auth_screens_chat_widgets_chat_message_bubble/Message/message.html)
7. [runtimeType](https://api.flutter.dev/flutter/foundation/Diagnosticable/runtimeType.html)
8. [Methods](views_after_auth_screens_chat_widgets_chat_message_bubble/Message-class.html#instance-methods)
9. [build](views_after_auth_screens_chat_widgets_chat_message_bubble/Message/build.html)
...
19. [Operators](views_after_auth_screens_chat_widgets_chat_message_bubble/Message-class.html#operators)
