...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="models_options_options/models_options_options-library-sidebar.html"}
<div>

# [models/options/options]{.kind-library} library
...
[[Options](../models_options_options/Options-class.html)]{.name}
