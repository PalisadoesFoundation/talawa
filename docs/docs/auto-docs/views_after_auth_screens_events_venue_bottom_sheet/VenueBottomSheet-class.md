...
[[VenueBottomSheet](../views_after_auth_screens_events_venue_bottom_sheet/VenueBottomSheet/VenueBottomSheet.html)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?] key, ][required [[List](https://api.flutter.dev/flutter/dart-core/List-class.html)[\<[[Venue](../models_events_event_venue/Venue-class.html)]\>]] venues]})]
...
[[venues](../views_after_auth_screens_events_venue_bottom_sheet/VenueBottomSheet/venues.html)] [→ [List](https://api.flutter.dev/flutter/dart-core/List-class.html)[\<[[Venue](../models_events_event_venue/Venue-class.html)]\>]]
:   a_line_ending_with_end_punctuation.
    ::: features
    final
    :::
...
[createState](../views_after_auth_screens_events_venue_bottom_sheet/VenueBottomSheet/createState.html) [→ \_VenueBottomSheetState ]
