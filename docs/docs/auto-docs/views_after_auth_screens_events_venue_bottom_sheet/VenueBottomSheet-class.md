...
[[VenueBottomSheet](../views_after_auth_screens_events_venue_bottom_sheet/VenueBottomSheet/VenueBottomSheet.md)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.md)?] key, ][required [[List](https://api.flutter.dev/flutter/dart-core/List-class.html)[\<[[Venue](../models_events_event_venue/Venue-class.md)]\>]] venues]})]
