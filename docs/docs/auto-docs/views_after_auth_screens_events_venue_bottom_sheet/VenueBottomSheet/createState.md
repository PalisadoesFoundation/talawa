...
later inserted into the tree again, the framework will call [createState](../../views_after_auth_screens_events_venue_bottom_sheet/VenueBottomSheet/createState.html)
