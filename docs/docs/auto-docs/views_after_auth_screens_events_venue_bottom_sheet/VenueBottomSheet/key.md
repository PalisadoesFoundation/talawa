...
and
[key](../../views_after_auth_screens_events_venue_bottom_sheet/VenueBottomSheet/key.md)
properties of the two widgets are
[operator==](../../views_after_auth_screens_events_venue_bottom_sheet/VenueBottomSheet/operator_equals.md),
