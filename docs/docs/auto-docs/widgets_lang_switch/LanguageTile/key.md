...
and [key](../../widgets_lang_switch/LanguageTile/key.md) properties of
the two widgets are
[operator==](../../widgets_lang_switch/LanguageTile/operator_equals.md),
...
[key](../../widgets_lang_switch/LanguageTile/key.md) allows the
