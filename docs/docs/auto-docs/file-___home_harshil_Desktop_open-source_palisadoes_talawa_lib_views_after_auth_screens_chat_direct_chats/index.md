...
direct\_chats library - Dart API
...
1. [talawa](../index.html)
2. views/after\_auth\_screens/chat/direct\_chats.dart
...
# views/after\_auth\_screens/chat/direct\_chats library


## Classes

[ChatTile](../file-___home_harshil_Desktop_open-source_palisadoes_talawa_lib_views_after_auth_screens_chat_direct_chats/ChatTile-class.html)

ChatTile return a widget for a tile in the list of Direct Chats in the Chat List Screen.

[DirectChats](../file-___home_harshil_Desktop_open-source_palisadoes_talawa_lib_views_after_auth_screens_chat_direct_chats/DirectChats-class.html)
