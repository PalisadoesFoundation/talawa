...
[TalawaErrorSnackBar](../widgets_talawa_error_snackbar/TalawaErrorSnackBar/TalawaErrorSnackBar.html)({[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)? key, required Duration duration, required String errorMessage, required [MessageType](../enums_enums/MessageType.html) messageType})
...
[duration](../widgets_talawa_error_snackbar/TalawaErrorSnackBar/duration.html)
→ Duration

Duration the snack bar is visible.
final

[errorMessage](../widgets_talawa_error_snackbar/TalawaErrorSnackBar/errorMessage.html)
→ String
...
[messageType](../widgets_talawa_error_snackbar/TalawaErrorSnackBar/messageType.html)
...
[build](../widgets_talawa_error_snackbar/TalawaErrorSnackBar/build.html)([BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html) context)
→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)
