...
[[TalawaErrorSnackBar](../widgets_talawa_error_snackbar/TalawaErrorSnackBar/TalawaErrorSnackBar.md)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.md)?] key, ][required [[Duration](https://api.flutter.dev/flutter/dart-core/Duration-class.html)] duration, ][required [[String](https://api.flutter.dev/flutter/dart-core/String-class.html)] errorMessage, ][required [[MessageType](../enums_enums/MessageType.md)] messageType]})]
