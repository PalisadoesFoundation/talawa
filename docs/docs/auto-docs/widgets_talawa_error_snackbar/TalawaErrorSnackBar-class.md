...
[[TalawaErrorSnackBar](../widgets_talawa_error_snackbar/TalawaErrorSnackBar/TalawaErrorSnackBar.html)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?] key, ][required [[Duration](https://api.flutter.dev/flutter/dart-core/Duration-class.html)] duration, ][required [[String](https://api.flutter.dev/flutter/dart-core/String-class.html)] errorMessage, ][required [[MessageType](../enums_enums/MessageType.html)] messageType]})]
...
[[duration](../widgets_talawa_error_snackbar/TalawaErrorSnackBar/duration.html)] [→ [Duration](https://api.flutter.dev/flutter/dart-core/Duration-class.html)]
:   Duration the snack bar is visible.
    ::: features
    final
    :::

[[errorMessage](../widgets_talawa_error_snackbar/TalawaErrorSnackBar/errorMessage.html)] [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)]
...
[[messageType](../widgets_talawa_error_snackbar/TalawaErrorSnackBar/messageType.html)] [→ [MessageType](../enums_enums/MessageType.html)]
...
[[build](../widgets_talawa_error_snackbar/TalawaErrorSnackBar/build.html)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
