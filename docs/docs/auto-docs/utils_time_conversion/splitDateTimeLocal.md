...
# <span class="kind-function">splitDateTimeLocal</span> function
...
<span class="name">splitDateTimeLocal</span>(

1.  <span id="splitDateTimeLocal-param-dateTimeStr"
    class="parameter"><span class="type-annotation">[String](https://api.flutter.dev/flutter/dart-core/String-class.md)?</span>
    <span class="parameter-name">dateTimeStr</span></span>
