...
# <span class="kind-function">convertLocalToUTC</span> function
...
<span class="name">convertLocalToUTC</span>(

1.  <span id="convertLocalToUTC-param-localTime"
    class="parameter"><span class="type-annotation">[String](https://api.flutter.dev/flutter/dart-core/String-class.md)?</span>
    <span class="parameter-name">localTime</span></span>
