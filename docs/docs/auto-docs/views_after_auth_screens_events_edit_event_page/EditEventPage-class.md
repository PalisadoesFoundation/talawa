...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="views_after_auth_screens_events_edit_event_page/views_after_auth_screens_events_edit_event_page-library-sidebar.html" below-sidebar="views_after_auth_screens_events_edit_event_page/EditEventPage-class-sidebar.html"}
<div>

# [EditEventPage]{.kind-class} class
...
[[EditEventPage](../views_after_auth_screens_events_edit_event_page/EditEventPage/EditEventPage.html)]{.name}[({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?]{.type-annotation} [key]{.parameter-name}, ]{#-param-key .parameter}[required [[Event](../models_events_event_model/Event-class.html)]{.type-annotation} [event]{.parameter-name}]{#-param-event .parameter}})]{.signature}
...
[[event](../views_after_auth_screens_events_edit_event_page/EditEventPage/event.html)]{.name} [→ [Event](../models_events_event_model/Event-class.html)]{.signature}
...
[[createState](../views_after_auth_screens_events_edit_event_page/EditEventPage/createState.html)]{.name}[() [→ \_EditEventPageState]{.returntype .parameter} ]{.signature}
