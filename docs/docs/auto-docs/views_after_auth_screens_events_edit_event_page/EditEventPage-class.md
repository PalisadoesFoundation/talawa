...
[[EditEventPage](../views_after_auth_screens_events_edit_event_page/EditEventPage/EditEventPage.html)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?] key, ][required [[Event](../models_events_event_model/Event-class.html)] event]})]
...
[[event](../views_after_auth_screens_events_edit_event_page/EditEventPage/event.html)] [→ [Event](../models_events_event_model/Event-class.html)]
...
[createState](../views_after_auth_screens_events_edit_event_page/EditEventPage/createState.html) [→ \_EditEventPageState ]
