...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="constants_constants/constants_constants-library-sidebar.html"}
<div>

# [constants/constants]{.kind-library} library
...
[[HiveKeys](../constants_constants/HiveKeys-class.html)]{.name}
...
[[languages](../constants_constants/languages.html)]{.name} [↔ [List](https://api.flutter.dev/flutter/dart-core/List-class.html)[\<[[Language](../models_language_language_model/Language-class.html)]{.type-parameter}\>]{.signature}]{.signature}
...
[[supportedCurrencies](../constants_constants/supportedCurrencies.html)]{.name} [↔ [List](https://api.flutter.dev/flutter/dart-core/List-class.html)[\<[[String](https://api.flutter.dev/flutter/dart-core/String-class.html)]{.type-parameter}\>]{.signature}]{.signature}
