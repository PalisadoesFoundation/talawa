...
above-sidebar="utils_app_localization/AppLocalizations-class-sidebar.html"
below-sidebar="">

<div>

# <span class="kind-method">strictTranslate</span> method
...
<span class="name">strictTranslate</span>(

1.  <span id="strictTranslate-param-key"
