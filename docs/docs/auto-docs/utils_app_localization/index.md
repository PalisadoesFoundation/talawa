...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="utils_app_localization/utils_app_localization-library-sidebar.html"}
<div>

# [utils/app_localization]{.kind-library} library
...
[[AppLocalizations](../utils_app_localization/AppLocalizations-class.html)]{.name}
:   This class provides methods to localize the application so that it
    can be available to users with different languages.

[[AppLocalizationsDelegate](../utils_app_localization/AppLocalizationsDelegate-class.html)]{.name}
