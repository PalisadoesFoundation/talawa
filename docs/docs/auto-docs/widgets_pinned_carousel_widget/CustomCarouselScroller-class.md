...
[CustomCarouselScroller](../widgets_pinned_carousel_widget/CustomCarouselScroller/CustomCarouselScroller.html)({[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)? key, required List<[Post](../models_post_post_model/Post-class.html)> pinnedPosts, required Function navigateToIndividualPostPage})
...
[navigateToIndividualPostPage](../widgets_pinned_carousel_widget/CustomCarouselScroller/navigateToIndividualPostPage.html)
→ Function

function to navigate to IndividualPostPage.
final

[pinnedPosts](../widgets_pinned_carousel_widget/CustomCarouselScroller/pinnedPosts.html)
