...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="widgets_pinned_carousel_widget/widgets_pinned_carousel_widget-library-sidebar.html" below-sidebar="widgets_pinned_carousel_widget/CustomCarouselScroller-class-sidebar.html"}
<div>

# [CustomCarouselScroller]{.kind-class} class
...
[[navigateToIndividualPostPage](../widgets_pinned_carousel_widget/CustomCarouselScroller/navigateToIndividualPostPage.html)]{.name} [→ [Function](https://api.flutter.dev/flutter/dart-core/Function-class.html)]{.signature}
:   function to navigate to IndividualPostPage.
    ::: features
    [final]{.feature}
    :::

[[pinnedPosts](../widgets_pinned_carousel_widget/CustomCarouselScroller/pinnedPosts.html)]{.name} [→ [List](https://api.flutter.dev/flutter/dart-core/List-class.html)[\<[[Post](../models_post_post_model/Post-class.html)]{.type-parameter}\>]{.signature}]{.signature}
:   List of pinnedposts.
    ::: features
    [final]{.feature}
    :::
...
[[createState](../widgets_pinned_carousel_widget/CustomCarouselScroller/createState.html)]{.name}[() [→ [CustomCarouselScrollerState](../widgets_pinned_carousel_widget/CustomCarouselScrollerState-class.html)]{.returntype .parameter} ]{.signature}
