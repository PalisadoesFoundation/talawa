...
[navigateToIndividualPostPage](../widgets_pinned_carousel_widget/PinnedPostCarousel/navigateToIndividualPostPage.html)
→ Function

Function that navigates to an individual post page.
final

[navigateToPinnedPostPage](../widgets_pinned_carousel_widget/PinnedPostCarousel/navigateToPinnedPostPage.html)
→ dynamic Function()

Function that navigates to a page displaying pinned posts.
final

[pinnedPosts](../widgets_pinned_carousel_widget/PinnedPostCarousel/pinnedPosts.html)
...
[build](../widgets_pinned_carousel_widget/PinnedPostCarousel/build.html)([BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html) context)
→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)
