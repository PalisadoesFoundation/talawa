:::::::::: {#dartdoc-main-content .main-content above-sidebar="views_after_auth_screens_org_info_screen/views_after_auth_screens_org_info_screen-library-sidebar.html" below-sidebar="views_after_auth_screens_org_info_screen/OrganisationInfoScreen-class-sidebar.html"}
<div>

# [OrganisationInfoScreen]{.kind-class} class
...
[[OrganisationInfoScreen](../views_after_auth_screens_org_info_screen/OrganisationInfoScreen/OrganisationInfoScreen.html)]{.name}[({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?]{.type-annotation} [key]{.parameter-name}, ]{#-param-key .parameter}[required [[OrgInfo](../models_organization_org_info/OrgInfo-class.html)]{.type-annotation} [orgInfo]{.parameter-name}]{#-param-orgInfo .parameter}})]{.signature}
...
[[orgInfo](../views_after_auth_screens_org_info_screen/OrganisationInfoScreen/orgInfo.html)]{.name} [→ [OrgInfo](../models_organization_org_info/OrgInfo-class.html)]{.signature}
...
[[build](../views_after_auth_screens_org_info_screen/OrganisationInfoScreen/build.html)]{.name}[([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)]{.type-annotation} [context]{.parameter-name}]{#build-param-context .parameter}) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)]{.returntype .parameter} ]{.signature}
