...
[[OrganisationInfoScreen](../views_after_auth_screens_org_info_screen/OrganisationInfoScreen/OrganisationInfoScreen.md)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.md)?] key, ][required [[OrgInfo](../models_organization_org_info/OrgInfo-class.md)] orgInfo]})]
