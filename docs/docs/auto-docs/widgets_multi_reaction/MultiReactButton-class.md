...
[[MultiReactButton](../widgets_multi_reaction/MultiReactButton/MultiReactButton.html)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?] key, ][required [[VoidCallback](https://api.flutter.dev/flutter/dart-ui/VoidCallback.html)] toggle]})]
...
[[toggle](../widgets_multi_reaction/MultiReactButton/toggle.html)] [→ [VoidCallback](https://api.flutter.dev/flutter/dart-ui/VoidCallback.html)]
...
[[createState](../widgets_multi_reaction/MultiReactButton/createState.html)][() [→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)[\<[[MultiReactButton](../widgets_multi_reaction/MultiReactButton-class.html)]\>]] ]
