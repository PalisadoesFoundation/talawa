...
[[MultiReactButton](../widgets_multi_reaction/MultiReactButton/MultiReactButton.md)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.md)?] key, ][required [[VoidCallback](https://api.flutter.dev/flutter/dart-ui/VoidCallback.html)] toggle]})]
...
[[toggle](../widgets_multi_reaction/MultiReactButton/toggle.md)] [→ [VoidCallback](https://api.flutter.dev/flutter/dart-ui/VoidCallback.html)]
...
[[createState](../widgets_multi_reaction/MultiReactButton/createState.md)][() [→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)[\<[[MultiReactButton](../widgets_multi_reaction/MultiReactButton-class.md)]\>]] ]
