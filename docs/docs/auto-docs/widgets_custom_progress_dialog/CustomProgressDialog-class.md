...
[CustomProgressDialog](../widgets_custom_progress_dialog/CustomProgressDialog/CustomProgressDialog.html)({required [Key](https://api.flutter.dev/flutter/foundation/Key-class.html) key})
...
[build](../widgets_custom_progress_dialog/CustomProgressDialog/build.html)([BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html) context)
→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)
