...
8.  [animate](https://pub.dev/documentation/flutter_animate/4.5.0/flutter_animate/AnimateWidgetExtensions/animate.html)
    ^(ext)^
9.  [build](widgets_custom_progress_dialog/CustomProgressDialog/build.html)
...
19. [Operators](widgets_custom_progress_dialog/CustomProgressDialog-class.html#operators)
20. [operator
