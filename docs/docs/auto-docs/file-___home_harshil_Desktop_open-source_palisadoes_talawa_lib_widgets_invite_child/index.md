...
invite\_child library - Dart API
...
# widgets/invite\_child library


## Functions

[iconButton](../file-___home_harshil_Desktop_open-source_palisadoes_talawa_lib_widgets_invite_child/iconButton.html)([String](https://api.flutter.dev/flutter/dart-core/String-class.html) key, dynamic icon, void onTap())
→ dynamic


It prints "tapped" in the console for the developer to know that the button was tapped.

[invite](../file-___home_harshil_Desktop_open-source_palisadoes_talawa_lib_widgets_invite_child/invite.html)(dynamic context)
→ dynamic
