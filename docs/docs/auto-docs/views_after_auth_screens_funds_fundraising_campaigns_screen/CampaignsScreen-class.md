...
<span class="name">[CampaignsScreen.new](../views_after_auth_screens_funds_fundraising_campaigns_screen/CampaignsScreen/CampaignsScreen.md)</span><span class="signature"></span>  
...
<span class="name">[createState](../views_after_auth_screens_funds_fundraising_campaigns_screen/CampaignsScreen/createState.md)</span><span class="signature"> <span class="returntype parameter">→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)<span class="signature">\<<span class="type-parameter">[CampaignsScreen](../views_after_auth_screens_funds_fundraising_campaigns_screen/CampaignsScreen-class.md)</span>\></span></span> </span>  
