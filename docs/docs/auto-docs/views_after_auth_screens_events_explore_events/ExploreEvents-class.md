...
[[ExploreEvents](../views_after_auth_screens_events_explore_events/ExploreEvents/ExploreEvents.html)][({[required [[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)] key, ][[[MainScreenViewModel](../view_model_main_screen_view_model/MainScreenViewModel-class.html)?] homeModel]})]
...
[[homeModel](../views_after_auth_screens_events_explore_events/ExploreEvents/homeModel.html)] [→ [MainScreenViewModel](../view_model_main_screen_view_model/MainScreenViewModel-class.html)?]
...
[[build](../views_after_auth_screens_events_explore_events/ExploreEvents/build.html)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
