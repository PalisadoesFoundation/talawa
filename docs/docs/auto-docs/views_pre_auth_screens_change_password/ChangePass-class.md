...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="views_pre_auth_screens_change_password/views_pre_auth_screens_change_password-library-sidebar.html" below-sidebar="views_pre_auth_screens_change_password/ChangePass-class-sidebar.html"}
<div>

# [ChangePass]{.kind-class} class
...
[[ChangePass](../views_pre_auth_screens_change_password/ChangePass/ChangePass.html)]{.name}[({[required [[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)]{.type-annotation} [key]{.parameter-name}]{#-param-key .parameter}})]{.signature}
...
[[createState](../views_pre_auth_screens_change_password/ChangePass/createState.html)]{.name}[() [→ \_ChangePassState]{.returntype .parameter} ]{.signature}
