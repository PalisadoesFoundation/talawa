...
and [key](../../widgets_talawa_error_dialog/TalawaErrorDialog/key.md)
properties of the two widgets are
[operator==](../../widgets_talawa_error_dialog/TalawaErrorDialog/operator_equals.md),
...
[key](../../widgets_talawa_error_dialog/TalawaErrorDialog/key.md)
