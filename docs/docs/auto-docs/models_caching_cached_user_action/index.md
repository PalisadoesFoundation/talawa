...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="models_caching_cached_user_action/models_caching_cached_user_action-library-sidebar.html"}
<div>

# [models/caching/cached_user_action]{.kind-library} library
...
[[CachedUserAction](../models_caching_cached_user_action/CachedUserAction-class.html)]{.name}
:   CachedUserAction class represents a user action that is cached for
    offline use.

[[CachedUserActionAdapter](../models_caching_cached_user_action/CachedUserActionAdapter-class.html)]{.name}
