...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="views_base_view/views_base_view-library-sidebar.html"}
<div>

# [views/base_view]{.kind-library} library
...
[[BaseView](../views_base_view/BaseView-class.html)[\<[T extends [ChangeNotifier](https://api.flutter.dev/flutter/foundation/ChangeNotifier-class.html)]{.type-parameter}\>]{.signature}]{.name}
