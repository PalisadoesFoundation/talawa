...
==](../../views_base_view/BaseView/operator_equals.md) comparisons.
...
If [operator ==](../../views_base_view/BaseView/operator_equals.md) is
...
==](../../views_base_view/BaseView/operator_equals.md). The hash code
of an object should only change if the object changes in a way that
...
[hashCode](../../views_base_view/BaseView/hashCode.md), it should
override the [operator
==](../../views_base_view/BaseView/operator_equals.md) operator as
