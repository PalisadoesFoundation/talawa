...
[[BaseView](../views_base_view/BaseView/BaseView.md)][({[required [[Widget](https://api.flutter.dev/flutter/widgets/Widget-class.md)] builder([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.md)], ][T, ][[[Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)?]]), ][dynamic onModelReady([T])?]})]
