...
3.  BaseView[\<[T extends
    [ChangeNotifier](https://api.flutter.dev/flutter/foundation/ChangeNotifier-class.html)]{.type-parameter}\>]{.signature}
    class
...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="views_base_view/views_base_view-library-sidebar.html" below-sidebar="views_base_view/BaseView-class-sidebar.html"}
<div>

# [BaseView\<[T extends ChangeNotifier]{.type-parameter}\>]{.kind-class} class
...
[[BaseView](../views_base_view/BaseView/BaseView.html)]{.name}[({[required [[Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)]{.type-annotation} [builder]{.parameter-name}([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)]{.type-annotation}, ]{#param- .parameter}[[T]{.type-annotation}, ]{#param- .parameter}[[[Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)?]{.type-annotation}]{#param- .parameter}), ]{#-param-builder .parameter}[[dynamic]{.type-annotation} [onModelReady]{.parameter-name}([[T]{.type-annotation}]{#param- .parameter})?]{#-param-onModelReady .parameter}})]{.signature}
...
[[builder](../views_base_view/BaseView/builder.html)]{.name} [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html) Function[([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)]{.type-annotation}, ]{#param- .parameter}[[T]{.type-annotation}, ]{#param- .parameter}[[[Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)?]{.type-annotation}]{#param- .parameter})]{.signature}]{.signature}
...
[[onModelReady](../views_base_view/BaseView/onModelReady.html)]{.name} [→ dynamic Function[([[T]{.type-annotation}]{#param- .parameter})]{.signature}?]{.signature}
...
[[createState](../views_base_view/BaseView/createState.html)]{.name}[() [→ \_BaseViewState[\<[T]{.type-parameter}\>]{.signature}]{.returntype .parameter} ]{.signature}
