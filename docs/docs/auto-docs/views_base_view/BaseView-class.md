...
[[BaseView](../views_base_view/BaseView/BaseView.html)][({[required [[Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] builder([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)], ][T, ][[[Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)?]]), ][dynamic onModelReady([T])?]})]
...
[[builder](../views_base_view/BaseView/builder.html)] [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html) Function[([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)], ][T, ][[[Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)?]])]]
...
[[onModelReady](../views_base_view/BaseView/onModelReady.html)] → dynamic Function[([[T])]?]
...
[createState](../views_base_view/BaseView/createState.html) [→ \_BaseViewState[\<[T\>]] ]
