...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="enums_enums/enums_enums-library-sidebar.html" below-sidebar="enums_enums/ModalSheet-enum-sidebar.html"}
<div>

# [ModalSheet]{.kind-enum} enum
...
[donation]{.name} [→ const [ModalSheet](../enums_enums/ModalSheet.html)]{.signature}

:   Represents the modal sheet for donation.

[invite]{.name} [→ const [ModalSheet](../enums_enums/ModalSheet.html)]{.signature}
...
[[values](../enums_enums/ModalSheet/values-constant.html)]{.name} [→ const [List](https://api.flutter.dev/flutter/dart-core/List-class.html)[\<[[ModalSheet](../enums_enums/ModalSheet.html)]{.type-parameter}\>]{.signature}]{.signature}
