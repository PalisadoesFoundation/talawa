::::::::::: {#dartdoc-main-content .main-content above-sidebar="enums_enums/enums_enums-library-sidebar.html" below-sidebar="enums_enums/ChatState-enum-sidebar.html"}
<div>

# [ChatState]{.kind-enum} enum
...
[initial]{.name} [→ const [ChatState](../enums_enums/ChatState.html)]{.signature}

:   The chat is at initial state.

[loading]{.name} [→ const [ChatState](../enums_enums/ChatState.html)]{.signature}

:   The chat is loading something.

[complete]{.name} [→ const [ChatState](../enums_enums/ChatState.html)]{.signature}
...
[[values](../enums_enums/ChatState/values-constant.html)]{.name} [→ const [List](https://api.flutter.dev/flutter/dart-core/List-class.html)[\<[[ChatState](../enums_enums/ChatState.html)]{.type-parameter}\>]{.signature}]{.signature}
