::::::::::: {#dartdoc-main-content .main-content above-sidebar="enums_enums/enums_enums-library-sidebar.html" below-sidebar="enums_enums/ViewState-enum-sidebar.html"}
<div>

# [ViewState]{.kind-enum} enum
...
[idle]{.name} [→ const [ViewState](../enums_enums/ViewState.html)]{.signature}

:   The view is not doing anything.

[busy]{.name} [→ const [ViewState](../enums_enums/ViewState.html)]{.signature}
...
[[values](../enums_enums/ViewState/values-constant.html)]{.name} [→ const [List](https://api.flutter.dev/flutter/dart-core/List-class.html)[\<[[ViewState](../enums_enums/ViewState.html)]{.type-parameter}\>]{.signature}]{.signature}
