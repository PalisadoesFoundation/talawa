...
above-sidebar="enums_enums/MessageType-enum-sidebar.html"
below-sidebar="">
...
[List](https://api.flutter.dev/flutter/dart-core/List-class.html)<span class="signature">\<<span class="type-parameter">[MessageType](../../enums_enums/MessageType.md)</span>\></span>
