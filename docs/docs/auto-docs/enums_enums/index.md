:::::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="enums_enums/enums_enums-library-sidebar.html"}
<div>

# [enums\\enums]{.kind-library} library
...
[[CachedOperationTypeAdapter](../enums_enums/CachedOperationTypeAdapter-class.html)]{.name}

:   

[[CachedUserActionStatusAdapter](../enums_enums/CachedUserActionStatusAdapter-class.html)]{.name}
...
[[ActionType](../enums_enums/ActionType.html)]{.name}
:   Enum representing the types of actions that can be performed.

[[CachedOperationType](../enums_enums/CachedOperationType.html)]{.name}
:   This enum defines the different types of cached GraphQL operations.

[[CachedUserActionStatus](../enums_enums/CachedUserActionStatus.html)]{.name}
:   This enum defines the possible statuses for a cached user action.

[[CallFor](../enums_enums/CallFor.html)]{.name}
:   Represents the type of CallFor.

[[ChatState](../enums_enums/ChatState.html)]{.name}
:   Represents the state of the chat.

[[MessageType](../enums_enums/MessageType.html)]{.name}
:   Represents the type of the Message.

[[ModalSheet](../enums_enums/ModalSheet.html)]{.name}
:   Represents the type of ModalSheet.

[[TileType](../enums_enums/TileType.html)]{.name}
:   Represents the type of the tile.

[[ViewState](../enums_enums/ViewState.html)]{.name}
