...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="enums_enums/enums_enums-library-sidebar.html" below-sidebar="enums_enums/CallFor-enum-sidebar.html"}
<div>

# [CallFor]{.kind-enum} enum
...
[login]{.name} [→ const [CallFor](../enums_enums/CallFor.html)]{.signature}

:   Represents the call for login.

[signup]{.name} [→ const [CallFor](../enums_enums/CallFor.html)]{.signature}

:   Represents the call for signup.

[joinPublicOrg]{.name} [→ const [CallFor](../enums_enums/CallFor.html)]{.signature}
...
[[values](../enums_enums/CallFor/values-constant.html)]{.name} [→ const [List](https://api.flutter.dev/flutter/dart-core/List-class.html)[\<[[CallFor](../enums_enums/CallFor.html)]{.type-parameter}\>]{.signature}]{.signature}
