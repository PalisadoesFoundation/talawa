...
[[ProfilePage](../views_after_auth_screens_profile_profile_page/ProfilePage/ProfilePage.html)][({[required [[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)] key, ][[[MainScreenViewModel](../view_model_main_screen_view_model/MainScreenViewModel-class.html)?] homeModel]})]
...
[[homeModel](../views_after_auth_screens_profile_profile_page/ProfilePage/homeModel.html)] [→ [MainScreenViewModel](../view_model_main_screen_view_model/MainScreenViewModel-class.html)?]
...
[[build](../views_after_auth_screens_profile_profile_page/ProfilePage/build.html)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
...
[[donate](../views_after_auth_screens_profile_profile_page/ProfilePage/donate.html)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)] context, ][[[ProfilePageViewModel](../view_model_after_auth_view_models_profile_view_models_profile_page_view_model/ProfilePageViewModel-class.html)] model]) → void ]
