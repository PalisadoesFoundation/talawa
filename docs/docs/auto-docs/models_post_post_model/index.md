...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="models_post_post_model/models_post_post_model-library-sidebar.html"}
<div>

# [models/post/post_model]{.kind-library} library
...
[[Comments](../models_post_post_model/Comments-class.html)]{.name}
:   This class convert between json and object for comments.

[[CommentsAdapter](../models_post_post_model/CommentsAdapter-class.html)]{.name}

:   

[[LikedBy](../models_post_post_model/LikedBy-class.html)]{.name}
:   This class convert between json and object for likedby.

[[LikedByAdapter](../models_post_post_model/LikedByAdapter-class.html)]{.name}

:   

[[Post](../models_post_post_model/Post-class.html)]{.name}
:   This class creates a Post model.

[[PostAdapter](../models_post_post_model/PostAdapter-class.html)]{.name}
