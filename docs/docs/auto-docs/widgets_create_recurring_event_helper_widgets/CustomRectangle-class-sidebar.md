...
9.  [animate](https://pub.dev/documentation/flutter_animate/4.5.0/flutter_animate/AnimateWidgetExtensions/animate.html)
    ^(ext)^
10. [build](widgets_create_recurring_event_helper_widgets/CustomRectangle/build.html)
...
20. [Operators](widgets_create_recurring_event_helper_widgets/CustomRectangle-class.html#operators)
21. [operator
