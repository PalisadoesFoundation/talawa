...
and
[key](../../widgets_create_recurring_event_helper_widgets/RecurrenceFrequencyDropdown/key.md)
properties of the two widgets are
[operator==](../../widgets_create_recurring_event_helper_widgets/RecurrenceFrequencyDropdown/operator_equals.md),
