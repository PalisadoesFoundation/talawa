...
later inserted into the tree again, the framework will call [createState](../../widgets_create_recurring_event_helper_widgets/RecurrenceFrequencyDropdown/createState.html)
