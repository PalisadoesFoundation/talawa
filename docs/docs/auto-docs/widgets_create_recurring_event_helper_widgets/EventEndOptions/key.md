...
and
[key](../../widgets_create_recurring_event_helper_widgets/EventEndOptions/key.md)
properties of the two widgets are
[operator==](../../widgets_create_recurring_event_helper_widgets/EventEndOptions/operator_equals.md),
