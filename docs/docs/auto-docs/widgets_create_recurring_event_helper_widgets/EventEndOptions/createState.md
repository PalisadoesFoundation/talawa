::::::::: {#dartdoc-main-content .main-content above-sidebar="widgets_create_recurring_event_helper_widgets/EventEndOptions-class-sidebar.html" below-sidebar=""}
<div>
...
[[State](https://api.flutter.dev/flutter/widgets/State-class.html)[\<[[EventEndOptions](../../widgets_create_recurring_event_helper_widgets/EventEndOptions-class.html)]{.type-parameter}\>]{.signature}]{.returntype}
[createState]{.name}()
...
[createState](../../widgets_create_recurring_event_helper_widgets/EventEndOptions/createState.html)
