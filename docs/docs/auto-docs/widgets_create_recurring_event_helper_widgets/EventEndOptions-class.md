...
<span class="name">[createState](../widgets_create_recurring_event_helper_widgets/EventEndOptions/createState.md)</span><span class="signature"> <span class="returntype parameter">→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)<span class="signature">\<<span class="type-parameter">[EventEndOptions](../widgets_create_recurring_event_helper_widgets/EventEndOptions-class.md)</span>\></span></span> </span>  
