...
[model](../widgets_create_recurring_event_helper_widgets/EventEndOptions/model.html)
...
→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)<[EventEndOptions](../widgets_create_recurring_event_helper_widgets/EventEndOptions-class.html)>
