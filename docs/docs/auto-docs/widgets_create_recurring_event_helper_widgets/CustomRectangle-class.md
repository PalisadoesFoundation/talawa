...
<span class="name">[CustomRectangle.new](../widgets_create_recurring_event_helper_widgets/CustomRectangle/CustomRectangle.md)</span><span class="signature"></span>  
...
<span class="name">[child](../widgets_create_recurring_event_helper_widgets/CustomRectangle/child.md)</span> <span class="signature">→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)</span>  
