...
[[CustomRectangle](../widgets_create_recurring_event_helper_widgets/CustomRectangle/CustomRectangle.md)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.md)?] key, ][required [[Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] child]})]
