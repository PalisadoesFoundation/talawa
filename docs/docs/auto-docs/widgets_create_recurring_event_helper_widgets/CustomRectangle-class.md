...
[[CustomRectangle](../widgets_create_recurring_event_helper_widgets/CustomRectangle/CustomRectangle.html)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?] key, ][required [[Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] child]})]
...
[[child](../widgets_create_recurring_event_helper_widgets/CustomRectangle/child.html)] [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)]
...
[[build](../widgets_create_recurring_event_helper_widgets/CustomRectangle/build.html)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
