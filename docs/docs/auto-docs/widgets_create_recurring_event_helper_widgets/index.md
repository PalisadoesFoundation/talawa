...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="widgets_create_recurring_event_helper_widgets/widgets_create_recurring_event_helper_widgets-library-sidebar.html"}
<div>

# [widgets/create_recurring_event_helper_widgets]{.kind-library} library
...
[[CustomRectangle](../widgets_create_recurring_event_helper_widgets/CustomRectangle-class.html)]{.name}
:   Builds a rectangle with custom properties.

[[CustomTextField](../widgets_create_recurring_event_helper_widgets/CustomTextField-class.html)]{.name}
:   Builds a TextField with custom properties.

[[EventEndOptions](../widgets_create_recurring_event_helper_widgets/EventEndOptions-class.html)]{.name}
:   Event ending configuration options.

[[RecurrenceFrequencyDropdown](../widgets_create_recurring_event_helper_widgets/RecurrenceFrequencyDropdown-class.html)]{.name}
