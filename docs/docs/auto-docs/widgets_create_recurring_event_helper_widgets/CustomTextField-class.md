:::::::::: {#dartdoc-main-content .main-content above-sidebar="widgets_create_recurring_event_helper_widgets/widgets_create_recurring_event_helper_widgets-library-sidebar.html" below-sidebar="widgets_create_recurring_event_helper_widgets/CustomTextField-class-sidebar.html"}
<div>

# [CustomTextField]{.kind-class} class
...
[[CustomTextField](../widgets_create_recurring_event_helper_widgets/CustomTextField/CustomTextField.html)]{.name}[({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?]{.type-annotation} [key]{.parameter-name}, ]{#-param-key .parameter}[[[int](https://api.flutter.dev/flutter/dart-core/int-class.html)?]{.type-annotation} [maxTextLength]{.parameter-name}, ]{#-param-maxTextLength .parameter}[required [[TextEditingController](https://api.flutter.dev/flutter/widgets/TextEditingController-class.html)]{.type-annotation} [textEditingController]{.parameter-name}, ]{#-param-textEditingController .parameter}[[[bool](https://api.flutter.dev/flutter/dart-core/bool-class.html)]{.type-annotation} [readOnly]{.parameter-name} = [false]{.default-value}, ]{#-param-readOnly .parameter}[[[bool](https://api.flutter.dev/flutter/dart-core/bool-class.html)?]{.type-annotation} [enabled]{.parameter-name}]{#-param-enabled .parameter}})]{.signature}
...
[[enabled](../widgets_create_recurring_event_helper_widgets/CustomTextField/enabled.html)]{.name} [→ [bool](https://api.flutter.dev/flutter/dart-core/bool-class.html)?]{.signature}
...
[[maxTextLength](../widgets_create_recurring_event_helper_widgets/CustomTextField/maxTextLength.html)]{.name} [→ [int](https://api.flutter.dev/flutter/dart-core/int-class.html)?]{.signature}
:   Max textLength the text field allows.
    ::: features
    [final]{.feature}
    :::

[[readOnly](../widgets_create_recurring_event_helper_widgets/CustomTextField/readOnly.html)]{.name} [→ [bool](https://api.flutter.dev/flutter/dart-core/bool-class.html)]{.signature}
...
[[textEditingController](../widgets_create_recurring_event_helper_widgets/CustomTextField/textEditingController.html)]{.name} [→ [TextEditingController](https://api.flutter.dev/flutter/widgets/TextEditingController-class.html)]{.signature}
...
[[build](../widgets_create_recurring_event_helper_widgets/CustomTextField/build.html)]{.name}[([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)]{.type-annotation} [context]{.parameter-name}]{#build-param-context .parameter}) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)]{.returntype .parameter} ]{.signature}
