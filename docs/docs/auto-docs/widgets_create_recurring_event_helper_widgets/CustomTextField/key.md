...
and
[key](../../widgets_create_recurring_event_helper_widgets/CustomTextField/key.md)
properties of the two widgets are
[operator==](../../widgets_create_recurring_event_helper_widgets/CustomTextField/operator_equals.md),
