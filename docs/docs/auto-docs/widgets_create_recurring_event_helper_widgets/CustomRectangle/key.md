...
and
[key](../../widgets_create_recurring_event_helper_widgets/CustomRectangle/key.md)
properties of the two widgets are
[operator==](../../widgets_create_recurring_event_helper_widgets/CustomRectangle/operator_equals.md),
