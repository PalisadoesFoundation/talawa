:::::::::: {#dartdoc-main-content .main-content above-sidebar="widgets_create_recurring_event_helper_widgets/widgets_create_recurring_event_helper_widgets-library-sidebar.html" below-sidebar="widgets_create_recurring_event_helper_widgets/RecurrenceFrequencyDropdown-class-sidebar.html"}
<div>

# [RecurrenceFrequencyDropdown]{.kind-class} class
...
[[RecurrenceFrequencyDropdown](../widgets_create_recurring_event_helper_widgets/RecurrenceFrequencyDropdown/RecurrenceFrequencyDropdown.html)]{.name}[({[required [[CreateEventViewModel](../view_model_after_auth_view_models_event_view_models_create_event_view_model/CreateEventViewModel-class.html)]{.type-annotation} [model]{.parameter-name}, ]{#-param-model .parameter}[required [void]{.type-annotation} [onSelected]{.parameter-name}([[[String](https://api.flutter.dev/flutter/dart-core/String-class.html)]{.type-annotation}]{#param- .parameter})?, ]{#-param-onSelected .parameter}[required [[List](https://api.flutter.dev/flutter/dart-core/List-class.html)[\<[[String](https://api.flutter.dev/flutter/dart-core/String-class.html)]{.type-parameter}\>]{.signature}]{.type-annotation} [options]{.parameter-name}, ]{#-param-options .parameter}[required [[String](https://api.flutter.dev/flutter/dart-core/String-class.html)]{.type-annotation} [selectedOption]{.parameter-name}]{#-param-selectedOption .parameter}})]{.signature}
...
[[model](../widgets_create_recurring_event_helper_widgets/RecurrenceFrequencyDropdown/model.html)]{.name} [→ [CreateEventViewModel](../view_model_after_auth_view_models_event_view_models_create_event_view_model/CreateEventViewModel-class.html)]{.signature}
:   Instance of create event view model.
    ::: features
    [final]{.feature}
    :::

[[onSelected](../widgets_create_recurring_event_helper_widgets/RecurrenceFrequencyDropdown/onSelected.html)]{.name} [→ void Function[([[[String](https://api.flutter.dev/flutter/dart-core/String-class.html)]{.type-annotation}]{#param- .parameter})]{.signature}?]{.signature}
:   Callback to be executed when selected value changes.
    ::: features
    [final]{.feature}
    :::

[[options](../widgets_create_recurring_event_helper_widgets/RecurrenceFrequencyDropdown/options.html)]{.name} [→ [List](https://api.flutter.dev/flutter/dart-core/List-class.html)[\<[[String](https://api.flutter.dev/flutter/dart-core/String-class.html)]{.type-parameter}\>]{.signature}]{.signature}
...
[[selectedOption](../widgets_create_recurring_event_helper_widgets/RecurrenceFrequencyDropdown/selectedOption.html)]{.name} [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)]{.signature}
:   Selected option.
    ::: features
    [final]{.feature}
    :::
...
[[createState](../widgets_create_recurring_event_helper_widgets/RecurrenceFrequencyDropdown/createState.html)]{.name}[() [→ \_RecurrenceFrequencyDropdownState]{.returntype .parameter} ]{.signature}
