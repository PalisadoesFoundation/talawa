...
SelectContact class - select\_contact library - Dart API
...
[SelectContact](../views_after_auth_screens_chat_select_contact/SelectContact/SelectContact.html)({[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)? key})
...
[createState](../views_after_auth_screens_chat_select_contact/SelectContact/createState.html)()
→ \_SelectContactState
