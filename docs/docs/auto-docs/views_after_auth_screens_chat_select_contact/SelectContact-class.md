:::::::::: {#dartdoc-main-content .main-content above-sidebar="views_after_auth_screens_chat_select_contact/views_after_auth_screens_chat_select_contact-library-sidebar.html" below-sidebar="views_after_auth_screens_chat_select_contact/SelectContact-class-sidebar.html"}
<div>

# [SelectContact]{.kind-class} class
...
[[SelectContact](../views_after_auth_screens_chat_select_contact/SelectContact/SelectContact.html)]{.name}[({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?]{.type-annotation} [key]{.parameter-name}]{#-param-key .parameter}})]{.signature}
...
[[createState](../views_after_auth_screens_chat_select_contact/SelectContact/createState.html)]{.name}[() [→ \_SelectContactState]{.returntype .parameter} ]{.signature}
