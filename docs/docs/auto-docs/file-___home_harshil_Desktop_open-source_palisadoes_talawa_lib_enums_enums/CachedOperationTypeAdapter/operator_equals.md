...
operator == method - CachedOperationTypeAdapter class - enums library - Dart API
...
the [hashCode](../../file-___home_harshil_Desktop_open-source_palisadoes_talawa_lib_enums_enums/CachedOperationTypeAdapter/hashCode.html) method as well to maintain consistency.
