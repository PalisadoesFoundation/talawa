...
and [key](../../widgets_recurrence_dialog/ShowRecurrenceDialog/key.md)
properties of the two widgets are
[operator==](../../widgets_recurrence_dialog/ShowRecurrenceDialog/operator_equals.md),
...
[key](../../widgets_recurrence_dialog/ShowRecurrenceDialog/key.md)
