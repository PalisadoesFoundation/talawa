...
[[TalawaPluginProvider](../plugins_talawa_plugin_provider/TalawaPluginProvider/TalawaPluginProvider.html)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?] key, ][@[required](https://api.flutter.dev/flutter/material/required-constant.html) [[Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)?] child, ][required [[bool](https://api.flutter.dev/flutter/dart-core/bool-class.html)] visible, ][required [[String](https://api.flutter.dev/flutter/dart-core/String-class.html)] pluginName]})]
...
[[child](../plugins_talawa_plugin_provider/TalawaPluginProvider/child.html)] [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)?]
...
[[pluginName](../plugins_talawa_plugin_provider/TalawaPluginProvider/pluginName.html)] [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)]
...
[[visible](../plugins_talawa_plugin_provider/TalawaPluginProvider/visible.html)] [→ [bool](https://api.flutter.dev/flutter/dart-core/bool-class.html)]
...
[[build](../plugins_talawa_plugin_provider/TalawaPluginProvider/build.html)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
:   Describes the part of the user interface represented by this widget.
    ::: features
    override
    :::

[[checkFromPluginList](../plugins_talawa_plugin_provider/TalawaPluginProvider/checkFromPluginList.html)][() [→ [bool](https://api.flutter.dev/flutter/dart-core/bool-class.html)] ]
