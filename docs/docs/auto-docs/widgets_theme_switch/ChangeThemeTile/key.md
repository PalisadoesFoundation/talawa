...
and [key](../../widgets_theme_switch/ChangeThemeTile/key.md)
properties of the two widgets are
[operator==](../../widgets_theme_switch/ChangeThemeTile/operator_equals.md),
...
[key](../../widgets_theme_switch/ChangeThemeTile/key.md) allows the
