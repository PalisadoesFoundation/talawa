...
[ChangeThemeTile](../widgets_theme_switch/ChangeThemeTile/ChangeThemeTile.html)({[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)? key})
...
[build](../widgets_theme_switch/ChangeThemeTile/build.html)([BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html) context)
→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)
