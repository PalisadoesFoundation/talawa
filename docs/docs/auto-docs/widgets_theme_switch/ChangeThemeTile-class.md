:::::::::: {#dartdoc-main-content .main-content above-sidebar="widgets_theme_switch/widgets_theme_switch-library-sidebar.html" below-sidebar="widgets_theme_switch/ChangeThemeTile-class-sidebar.html"}
<div>

# [ChangeThemeTile]{.kind-class} class
...
[[ChangeThemeTile](../widgets_theme_switch/ChangeThemeTile/ChangeThemeTile.html)]{.name}[({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?]{.type-annotation} [key]{.parameter-name}]{#-param-key .parameter}})]{.signature}
...
[[build](../widgets_theme_switch/ChangeThemeTile/build.html)]{.name}[([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)]{.type-annotation} [context]{.parameter-name}]{#build-param-context .parameter}) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)]{.returntype .parameter} ]{.signature}
