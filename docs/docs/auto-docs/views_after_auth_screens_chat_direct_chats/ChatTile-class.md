...
[[ChatTile](../views_after_auth_screens_chat_direct_chats/ChatTile/ChatTile.html)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?] key, ][required [[ChatListTileDataModel](../models_chats_chat_list_tile_data_model/ChatListTileDataModel-class.html)] chat, ][required [[DirectChatViewModel](../view_model_after_auth_view_models_chat_view_models_direct_chat_view_model/DirectChatViewModel-class.html)] model]})]
...
[[chat](../views_after_auth_screens_chat_direct_chats/ChatTile/chat.html)] [→ [ChatListTileDataModel](../models_chats_chat_list_tile_data_model/ChatListTileDataModel-class.html)]
...
[[model](../views_after_auth_screens_chat_direct_chats/ChatTile/model.html)] [→ [DirectChatViewModel](../view_model_after_auth_view_models_chat_view_models_direct_chat_view_model/DirectChatViewModel-class.html)]
...
[[build](../views_after_auth_screens_chat_direct_chats/ChatTile/build.html)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
