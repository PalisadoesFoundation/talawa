:::::::::: {#dartdoc-main-content .main-content above-sidebar="views_after_auth_screens_chat_direct_chats/views_after_auth_screens_chat_direct_chats-library-sidebar.html" below-sidebar="views_after_auth_screens_chat_direct_chats/ChatTile-class-sidebar.html"}
<div>

# [ChatTile]{.kind-class} class
...
[[ChatTile](../views_after_auth_screens_chat_direct_chats/ChatTile/ChatTile.html)]{.name}[({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?]{.type-annotation} [key]{.parameter-name}, ]{#-param-key .parameter}[required [[ChatListTileDataModel](../models_chats_chat_list_tile_data_model/ChatListTileDataModel-class.html)]{.type-annotation} [chat]{.parameter-name}, ]{#-param-chat .parameter}[required [[DirectChatViewModel](../view_model_after_auth_view_models_chat_view_models_direct_chat_view_model/DirectChatViewModel-class.html)]{.type-annotation} [model]{.parameter-name}]{#-param-model .parameter}})]{.signature}
...
[[chat](../views_after_auth_screens_chat_direct_chats/ChatTile/chat.html)]{.name} [→ [ChatListTileDataModel](../models_chats_chat_list_tile_data_model/ChatListTileDataModel-class.html)]{.signature}
...
[[model](../views_after_auth_screens_chat_direct_chats/ChatTile/model.html)]{.name} [→ [DirectChatViewModel](../view_model_after_auth_view_models_chat_view_models_direct_chat_view_model/DirectChatViewModel-class.html)]{.signature}
...
[[build](../views_after_auth_screens_chat_direct_chats/ChatTile/build.html)]{.name}[([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)]{.type-annotation} [context]{.parameter-name}]{#build-param-context .parameter}) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)]{.returntype .parameter} ]{.signature}
