...
[[DirectChats](../views_after_auth_screens_chat_direct_chats/DirectChats/DirectChats.html)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?] key]})]
...
[[build](../views_after_auth_screens_chat_direct_chats/DirectChats/build.html)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
