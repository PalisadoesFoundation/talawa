...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="locator/locator-library-sidebar.html"}
<div>

# [locator]{.kind-library} library

</div>

::: {#properties .section .summary .offset-anchor}
## Properties

[[actionHandlerService](../locator/actionHandlerService.html)]{.name} [→ [ActionHandlerService](../services_user_action_handler/ActionHandlerService-class.html)]{.signature}
:   GetIt for ActonHandlerService.
    ::: features
    [final]{.feature}
    :::

[[cacheService](../locator/cacheService.html)]{.name} [→ [CacheService](../services_caching_cache_service/CacheService-class.html)]{.signature}
:   GetIt for CacheService.
    ::: features
    [final]{.feature}
    :::

[[connectivity](../locator/connectivity.html)]{.name} [→ [Connectivity](https://pub.dev/documentation/connectivity_plus/6.1.1/connectivity_plus/Connectivity-class.html)]{.signature}
:   GetIt for Connectivity.
    ::: features
    [final]{.feature}
    :::

[[connectivityService](../locator/connectivityService.html)]{.name} [→ [ConnectivityService](../services_third_party_service_connectivity_service/ConnectivityService-class.html)]{.signature}
:   GetIt for ConnectivityService.
    ::: features
    [final]{.feature}
    :::

[[databaseFunctions](../locator/databaseFunctions.html)]{.name} [→ [DataBaseMutationFunctions](../services_database_mutation_functions/DataBaseMutationFunctions-class.html)]{.signature}
:   GetIt for DataBaseMutationFunctions.
    ::: features
    [final]{.feature}
    :::

[[graphqlConfig](../locator/graphqlConfig.html)]{.name} [→ [GraphqlConfig](../services_graphql_config/GraphqlConfig-class.html)]{.signature}
:   GetIt for GraphqlConfig.
    ::: features
    [final]{.feature}
    :::

[[imageService](../locator/imageService.html)]{.name} [→ [ImageService](../services_image_service/ImageService-class.html)]{.signature}
:   GetIt for ImageService.
    ::: features
    [final]{.feature}
    :::

[[locator](../locator/locator.html)]{.name} [↔ [GetIt](https://pub.dev/documentation/get_it/8.0.3/get_it/GetIt-class.html)]{.signature}
:   Intializaing the locator.
    ::: features
    [getter/setter pair]{.feature}
    :::

[[navigationService](../locator/navigationService.html)]{.name} [→ [NavigationService](../services_navigation_service/NavigationService-class.html)]{.signature}
:   GetIt for NavigationService.
    ::: features
    [final]{.feature}
    :::

[[organizationService](../locator/organizationService.html)]{.name} [→ [OrganizationService](../services_org_service/OrganizationService-class.html)]{.signature}
:   GetIt for OrganizationService.
    ::: features
    [final]{.feature}
    :::

[[queries](../locator/queries.html)]{.name} [→ [Queries](../utils_queries/Queries-class.html)]{.signature}
:   GetIt for Queries.
    ::: features
    [final]{.feature}
    :::

[[sessionManager](../locator/sessionManager.html)]{.name} [→ [SessionManager](../services_session_manager/SessionManager-class.html)]{.signature}
:   GetIt for SessionManager.
    ::: features
    [final]{.feature}
    :::

[[sizeConfig](../locator/sizeConfig.html)]{.name} [→ [SizeConfig](../services_size_config/SizeConfig-class.html)]{.signature}
:   GetIt for SizeConfig.
    ::: features
    [final]{.feature}
    :::

[[userConfig](../locator/userConfig.html)]{.name} [→ [UserConfig](../services_user_config/UserConfig-class.html)]{.signature}
...
[[setupLocator](../locator/setupLocator.html)]{.name}[() [→ [Future](https://api.flutter.dev/flutter/dart-core/Future-class.html)[\<[void]{.type-parameter}\>]{.signature}]{.returntype .parameter} ]{.signature}
