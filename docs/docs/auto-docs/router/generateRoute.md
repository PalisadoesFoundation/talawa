...
generateRoute function - router library - Dart API
...
1. [talawa](../index.html)
2. [router.dart](../router/router-library.html)
...
1. [RouteSettings](https://api.flutter.dev/flutter/widgets/RouteSettings-class.html) settings

)

The MaterialApp provides us with a property called generateRoute where.

we can pass in a Function that returns a Route and takes in RouteSettings
...
1. [talawa](../index.html)
2. [router](../router/router-library.html)
3. generateRoute function
