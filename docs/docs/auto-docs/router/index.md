...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="router/router-library-sidebar.html"}
<div>

# [router]{.kind-library} library
...
[[generateRoute](../router/generateRoute.html)]{.name}[([[[RouteSettings](https://api.flutter.dev/flutter/widgets/RouteSettings-class.html)]{.type-annotation} [settings]{.parameter-name}]{#generateRoute-param-settings .parameter}) [→ [Route](https://api.flutter.dev/flutter/widgets/Route-class.html)]{.returntype .parameter} ]{.signature}
