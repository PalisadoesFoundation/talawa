...
[[ManageAgendaScreen](../views_after_auth_screens_events_manage_agenda_items_screen/ManageAgendaScreen/ManageAgendaScreen.md)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.md)?] key]})]
