...
[[ManageAgendaScreen](../views_after_auth_screens_events_manage_agenda_items_screen/ManageAgendaScreen/ManageAgendaScreen.html)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?] key]})]
...
[[build](../views_after_auth_screens_events_manage_agenda_items_screen/ManageAgendaScreen/build.html)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
