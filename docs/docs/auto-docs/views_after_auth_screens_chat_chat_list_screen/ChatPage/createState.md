...
<span class="returntype">[State](https://api.flutter.dev/flutter/widgets/State-class.html)<span class="signature">\<<span class="type-parameter">[ChatPage](../../views_after_auth_screens_chat_chat_list_screen/ChatPage-class.md)</span>\></span></span>
