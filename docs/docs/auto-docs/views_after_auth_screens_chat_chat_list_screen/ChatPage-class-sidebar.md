...
8.  [animate](https://pub.dev/documentation/flutter_animate/4.5.0/flutter_animate/AnimateWidgetExtensions/animate.html)
    ^(ext)^
9.  [build](views_after_auth_screens_chat_chat_list_screen/ChatPage/build.html)
...
19. [Operators](views_after_auth_screens_chat_chat_list_screen/ChatPage-class.html#operators)
20. [operator
