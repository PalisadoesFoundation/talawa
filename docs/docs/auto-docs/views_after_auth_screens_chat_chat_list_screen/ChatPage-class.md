...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="views_after_auth_screens_chat_chat_list_screen/views_after_auth_screens_chat_chat_list_screen-library-sidebar.html" below-sidebar="views_after_auth_screens_chat_chat_list_screen/ChatPage-class-sidebar.html"}
<div>

# [ChatPage]{.kind-class} class
...
[[ChatPage](../views_after_auth_screens_chat_chat_list_screen/ChatPage/ChatPage.html)]{.name}[({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?]{.type-annotation} [key]{.parameter-name}]{#-param-key .parameter}})]{.signature}
...
[[build](../views_after_auth_screens_chat_chat_list_screen/ChatPage/build.html)]{.name}[([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)]{.type-annotation} [context]{.parameter-name}]{#build-param-context .parameter}) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)]{.returntype .parameter} ]{.signature}
