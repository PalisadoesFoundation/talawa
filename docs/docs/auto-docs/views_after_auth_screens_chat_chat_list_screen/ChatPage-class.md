...
<span class="name">[ChatPage.new](../views_after_auth_screens_chat_chat_list_screen/ChatPage/ChatPage.md)</span><span class="signature"></span>  
...
<span class="name">[createState](../views_after_auth_screens_chat_chat_list_screen/ChatPage/createState.md)</span><span class="signature"> <span class="returntype parameter">→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)<span class="signature">\<<span class="type-parameter">[ChatPage](../views_after_auth_screens_chat_chat_list_screen/ChatPage-class.md)</span>\></span></span> </span>  
