...
ChatPage class - chat\_list\_screen library - Dart API
...
[ChatPage](../views_after_auth_screens_chat_chat_list_screen/ChatPage/ChatPage.html)({[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)? key})
...
[build](../views_after_auth_screens_chat_chat_list_screen/ChatPage/build.html)([BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html) context)
→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)
