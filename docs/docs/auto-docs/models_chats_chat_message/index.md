...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="models_chats_chat_message/models_chats_chat_message-library-sidebar.html"}
<div>

# [models/chats/chat_message]{.kind-library} library
...
[[ChatMessage](../models_chats_chat_message/ChatMessage-class.html)]{.name}
