...
and [key](../../widgets_video_widget/VideoWidget/key.md) properties of
the two widgets are
[operator==](../../widgets_video_widget/VideoWidget/operator_equals.md),
...
[key](../../widgets_video_widget/VideoWidget/key.md) allows the
