...
[VideoWidget](../widgets_video_widget/VideoWidget/VideoWidget.html)({[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)? key, required String url, required bool play})
...
[play](../widgets_video_widget/VideoWidget/play.html)
→ bool
...
[url](../widgets_video_widget/VideoWidget/url.html)
→ String
...
[createState](../widgets_video_widget/VideoWidget/createState.html)()
→ \_VideoWidgetState
