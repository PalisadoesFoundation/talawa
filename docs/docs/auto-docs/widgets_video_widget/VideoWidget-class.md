...
[[VideoWidget](../widgets_video_widget/VideoWidget/VideoWidget.md)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.md)?] key, ][required [[String](https://api.flutter.dev/flutter/dart-core/String-class.html)] url, ][required [[bool](https://api.flutter.dev/flutter/dart-core/bool-class.html)] play]})]
