...
# <span class="kind-constructor">OrgInfo.fromJson</span> constructor

</div>

<div class="section multi-line-signature">

<span class="name">OrgInfo.fromJson</span>(
...
- `memberRequest`: A boolean flag to indicate if the request is from a
  member.
