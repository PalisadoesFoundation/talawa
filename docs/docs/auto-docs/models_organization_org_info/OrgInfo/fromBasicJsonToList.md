...
# <span class="kind-method">fromBasicJsonToList</span> method
...
<span class="name">fromBasicJsonToList</span>(

1.  <span id="fromBasicJsonToList-param-data"
