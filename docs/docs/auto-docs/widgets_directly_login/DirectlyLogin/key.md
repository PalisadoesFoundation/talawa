...
and [key](../../widgets_directly_login/DirectlyLogin/key.md)
properties of the two widgets are
[operator==](../../widgets_directly_login/DirectlyLogin/operator_equals.md),
...
[key](../../widgets_directly_login/DirectlyLogin/key.md) allows the
