...
[[DirectlyLogin](../widgets_directly_login/DirectlyLogin/DirectlyLogin.html)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?] key, ][required [[LoginViewModel](../view_model_pre_auth_view_models_login_view_model/LoginViewModel-class.html)] model]})]
...
[[model](../widgets_directly_login/DirectlyLogin/model.html)] [→ [LoginViewModel](../view_model_pre_auth_view_models_login_view_model/LoginViewModel-class.html)]
...
[[build](../widgets_directly_login/DirectlyLogin/build.html)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
...
[[loginUsingPrevCredentials](../widgets_directly_login/DirectlyLogin/loginUsingPrevCredentials.html)][() [→ [Future](https://api.flutter.dev/flutter/dart-core/Future-class.html)\<[void\>]] ]
