...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="exceptions_critical_action_exception/exceptions_critical_action_exception-library-sidebar.html"}
<div>

# [exceptions/critical_action_exception]{.kind-library} library

</div>

::: {#exceptions .section .summary .offset-anchor}
## Exceptions / Errors

[[CriticalActionException](../exceptions_critical_action_exception/CriticalActionException-class.html)]{.name}
