...
# <span class="kind-constructor">CriticalActionException</span> constructor

</div>

<div class="section multi-line-signature">

<span class="name">CriticalActionException</span>(

1.  <span id="-param-actionError"
    class="parameter"><span class="type-annotation">[String](https://api.flutter.dev/flutter/dart-core/String-class.md)</span>
    <span class="parameter-name">actionError</span></span>
