...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="custom_painters_telegram_logo/custom_painters_telegram_logo-library-sidebar.html"}
<div>

# [custom_painters/telegram_logo]{.kind-library} library
...
[[TelegramLogo](../custom_painters_telegram_logo/TelegramLogo-class.html)]{.name}
:   This class draws the telegram logo using custom paint. CustomPaint
    is a widget from the Flutter SDK, which enables you to use a canvas
