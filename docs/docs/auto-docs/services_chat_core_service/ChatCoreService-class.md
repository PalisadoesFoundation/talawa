...
<span class="name">[createChat](../services_chat_core_service/ChatCoreService/createChat.md)</span><span class="signature">(<span id="createChat-param-name" class="parameter"></span>) <span class="returntype parameter">→ [Future](https://api.flutter.dev/flutter/dart-async/Future-class.html)<span class="signature">\<<span class="type-parameter">[Chat](../models_chats_chat/Chat-class.md)?</span>\></span></span> </span>  
Creates a new chat.
...
<span class="name">[updateChat](../services_chat_core_service/ChatCoreService/updateChat.md)</span><span class="signature">(<span id="updateChat-param-chatId" class="parameter"></span>) <span class="returntype parameter">→ [Future](https://api.flutter.dev/flutter/dart-async/Future-class.html)<span class="signature">\<<span class="type-parameter">[bool](https://api.flutter.dev/flutter/dart-core/bool-class.html)</span>\></span></span> </span>  
