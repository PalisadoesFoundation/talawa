:::::::::: {#dartdoc-main-content .main-content above-sidebar="views_pre_auth_screens_recover/views_pre_auth_screens_recover-library-sidebar.html" below-sidebar="views_pre_auth_screens_recover/Recover-class-sidebar.html"}
<div>

# [Recover]{.kind-class} class
...
[[Recover](../views_pre_auth_screens_recover/Recover/Recover.html)]{.name}[({[required [[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)]{.type-annotation} [key]{.parameter-name}]{#-param-key .parameter}})]{.signature}
...
[[createState](../views_pre_auth_screens_recover/Recover/createState.html)]{.name}[() [→ \_RecoverState]{.returntype .parameter} ]{.signature}
