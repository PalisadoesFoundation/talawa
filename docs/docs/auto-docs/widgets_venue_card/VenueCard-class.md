...
[[VenueCard](../widgets_venue_card/VenueCard/VenueCard.html)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?] key, ][required [[Venue](../models_events_event_venue/Venue-class.html)] venue, ][[[bool](https://api.flutter.dev/flutter/dart-core/bool-class.html)] isSelected = false]})]
...
[[isSelected](../widgets_venue_card/VenueCard/isSelected.html)] [→ [bool](https://api.flutter.dev/flutter/dart-core/bool-class.html)]
...
[[venue](../widgets_venue_card/VenueCard/venue.html)] [→ [Venue](../models_events_event_venue/Venue-class.html)]
...
[[build](../widgets_venue_card/VenueCard/build.html)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
