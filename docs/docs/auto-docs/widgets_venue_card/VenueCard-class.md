...
[[VenueCard](../widgets_venue_card/VenueCard/VenueCard.md)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.md)?] key, ][required [[Venue](../models_events_event_venue/Venue-class.md)] venue, ][[[bool](https://api.flutter.dev/flutter/dart-core/bool-class.html)] isSelected = false]})]
