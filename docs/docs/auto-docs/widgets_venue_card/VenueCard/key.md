...
and [key](../../widgets_venue_card/VenueCard/key.md) properties of the
two widgets are
...
[key](../../widgets_venue_card/VenueCard/key.md) allows the element to
be moved around the tree (changing parent) without losing state. When a
