...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="views_after_auth_screens_events_volunteer_groups_screen/views_after_auth_screens_events_volunteer_groups_screen-library-sidebar.html" below-sidebar="views_after_auth_screens_events_volunteer_groups_screen/VolunteerGroupsScreen-class-sidebar.html"}
<div>

# [VolunteerGroupsScreen]{.kind-class} class
...
[[VolunteerGroupsScreen](../views_after_auth_screens_events_volunteer_groups_screen/VolunteerGroupsScreen/VolunteerGroupsScreen.html)]{.name}[({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?]{.type-annotation} [key]{.parameter-name}, ]{#-param-key .parameter}[required [[Event](../models_events_event_model/Event-class.html)]{.type-annotation} [event]{.parameter-name}, ]{#-param-event .parameter}[required [[EventInfoViewModel](../view_model_after_auth_view_models_event_view_models_event_info_view_model/EventInfoViewModel-class.html)]{.type-annotation} [model]{.parameter-name}]{#-param-model .parameter}})]{.signature}
...
[[event](../views_after_auth_screens_events_volunteer_groups_screen/VolunteerGroupsScreen/event.html)]{.name} [→ [Event](../models_events_event_model/Event-class.html)]{.signature}
...
[[model](../views_after_auth_screens_events_volunteer_groups_screen/VolunteerGroupsScreen/model.html)]{.name} [→ [EventInfoViewModel](../view_model_after_auth_view_models_event_view_models_event_info_view_model/EventInfoViewModel-class.html)]{.signature}
...
[[createState](../views_after_auth_screens_events_volunteer_groups_screen/VolunteerGroupsScreen/createState.html)]{.name}[() [→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)[\<[[VolunteerGroupsScreen](../views_after_auth_screens_events_volunteer_groups_screen/VolunteerGroupsScreen-class.html)]{.type-parameter}\>]{.signature}]{.returntype .parameter} ]{.signature}
