...
[[VolunteerGroupsScreen](../views_after_auth_screens_events_volunteer_groups_screen/VolunteerGroupsScreen/VolunteerGroupsScreen.html)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?] key, ][required [[Event](../models_events_event_model/Event-class.html)] event, ][required [[EventInfoViewModel](../view_model_after_auth_view_models_event_view_models_event_info_view_model/EventInfoViewModel-class.html)] model]})]
...
[[event](../views_after_auth_screens_events_volunteer_groups_screen/VolunteerGroupsScreen/event.html)] [→ [Event](../models_events_event_model/Event-class.html)]
...
[[model](../views_after_auth_screens_events_volunteer_groups_screen/VolunteerGroupsScreen/model.html)] [→ [EventInfoViewModel](../view_model_after_auth_view_models_event_view_models_event_info_view_model/EventInfoViewModel-class.html)]
...
[[createState](../views_after_auth_screens_events_volunteer_groups_screen/VolunteerGroupsScreen/createState.html)][() [→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)[\<[[VolunteerGroupsScreen](../views_after_auth_screens_events_volunteer_groups_screen/VolunteerGroupsScreen-class.html)]\>]] ]
