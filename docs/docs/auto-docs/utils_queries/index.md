...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="utils_queries/utils_queries-library-sidebar.html"}
<div>

# [utils/queries]{.kind-library} library
...
[[Queries](../utils_queries/Queries-class.html)]{.name}
