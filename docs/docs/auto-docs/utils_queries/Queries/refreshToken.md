...
# <span class="kind-method">refreshToken</span> method
...
<span class="name">refreshToken</span>(

1.  <span id="refreshToken-param-refreshToken"
    class="parameter"><span class="type-annotation">[String](https://api.flutter.dev/flutter/dart-core/String-class.md)</span>
    <span class="parameter-name">refreshToken</span></span>
...
- `refreshToken`: related to auth, token based authentication, mutation
