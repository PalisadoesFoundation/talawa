...
# <span class="kind-method">updateLanguage</span> method
...
<span class="name">updateLanguage</span>(

1.  <span id="updateLanguage-param-languageCode"
    class="parameter"><span class="type-annotation">[String](https://api.flutter.dev/flutter/dart-core/String-class.md)</span>
    <span class="parameter-name">languageCode</span></span>
