...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="widgets_post_container/widgets_post_container-library-sidebar.html"}
<div>

# [widgets/post_container]{.kind-library} library
...
[[PostContainer](../widgets_post_container/PostContainer-class.html)]{.name}
:   the widget which contains the actual image.

[[PostContainerState](../widgets_post_container/PostContainerState-class.html)]{.name}
