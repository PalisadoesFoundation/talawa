...
[PostContainer](../widgets_post_container/PostContainer/PostContainer.html)({[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)? key, required String? photoUrl})
...
[photoUrl](../widgets_post_container/PostContainer/photoUrl.html)
→ String?
