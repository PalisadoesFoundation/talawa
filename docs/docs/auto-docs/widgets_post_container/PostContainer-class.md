...
[[PostContainer](../widgets_post_container/PostContainer/PostContainer.html)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?] key, ][required [[String](https://api.flutter.dev/flutter/dart-core/String-class.html)?] photoUrl]})]
...
[[photoUrl](../widgets_post_container/PostContainer/photoUrl.html)] [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)?]
:   image url.
    ::: features
    final
    :::
...
[[createState](../widgets_post_container/PostContainer/createState.html)][() [→ [PostContainerState](../widgets_post_container/PostContainerState-class.html)] ]
