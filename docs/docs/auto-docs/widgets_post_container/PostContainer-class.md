...
<span class="name">[createState](../widgets_post_container/PostContainer/createState.md)</span><span class="signature"> <span class="returntype parameter">→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)<span class="signature">\<<span class="type-parameter">[PostContainer](../widgets_post_container/PostContainer-class.md)</span>\></span></span> </span>  
