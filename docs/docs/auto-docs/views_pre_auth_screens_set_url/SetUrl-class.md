...
[[SetUrl](../views_pre_auth_screens_set_url/SetUrl/SetUrl.html)][({[required [[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)] key, ][required [[String](https://api.flutter.dev/flutter/dart-core/String-class.html)] uri]})]
...
[[uri](../views_pre_auth_screens_set_url/SetUrl/uri.html)] [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)]
:   Variable.
    ::: features
    final
    :::
...
[createState](../views_pre_auth_screens_set_url/SetUrl/createState.html) [→ \_SetUrlState ]
