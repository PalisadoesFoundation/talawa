...
4.  validateGroupName static method
...
# <span class="kind-method">validateGroupName</span> static method
...
<span class="name">validateGroupName</span>(

1.  <span id="validateGroupName-param-name"
