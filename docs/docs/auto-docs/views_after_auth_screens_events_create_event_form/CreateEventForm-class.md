...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="views_after_auth_screens_events_create_event_form/views_after_auth_screens_events_create_event_form-library-sidebar.html" below-sidebar="views_after_auth_screens_events_create_event_form/CreateEventForm-class-sidebar.html"}
<div>

# [CreateEventForm]{.kind-class} class
...
[[model](../views_after_auth_screens_events_create_event_form/CreateEventForm/model.html)]{.name} [→ [CreateEventViewModel](../view_model_after_auth_view_models_event_view_models_create_event_view_model/CreateEventViewModel-class.html)]{.signature}
...
[[build](../views_after_auth_screens_events_create_event_form/CreateEventForm/build.html)]{.name}[([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)]{.type-annotation} [context]{.parameter-name}]{#build-param-context .parameter}) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)]{.returntype .parameter} ]{.signature}
