...
[model](../views_after_auth_screens_events_create_event_form/CreateEventForm/model.html)
...
[build](../views_after_auth_screens_events_create_event_form/CreateEventForm/build.html)([BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html) context)
→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)
