...
[customDatePicker](../widgets_date_time_picker/customDatePicker.html)({required DateTime initialDate})
→ Future<DateTime>


Shows a dialog containing a Material Design date picker.

[customTimePicker](../widgets_date_time_picker/customTimePicker.html)({required [TimeOfDay](https://api.flutter.dev/flutter/material/TimeOfDay-class.html) initialTime})
