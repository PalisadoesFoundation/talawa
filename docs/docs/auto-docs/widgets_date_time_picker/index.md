...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="widgets_date_time_picker/widgets_date_time_picker-library-sidebar.html"}
<div>

# [widgets/date_time_picker]{.kind-library} library
...
[[customDatePicker](../widgets_date_time_picker/customDatePicker.html)]{.name}[({[required [[DateTime](https://api.flutter.dev/flutter/dart-core/DateTime-class.html)]{.type-annotation} [initialDate]{.parameter-name}]{#customDatePicker-param-initialDate .parameter}}) [→ [Future](https://api.flutter.dev/flutter/dart-core/Future-class.html)[\<[[DateTime](https://api.flutter.dev/flutter/dart-core/DateTime-class.html)]{.type-parameter}\>]{.signature}]{.returntype .parameter} ]{.signature}
:   Shows a dialog containing a Material Design date picker.

[[customTimePicker](../widgets_date_time_picker/customTimePicker.html)]{.name}[({[required [[TimeOfDay](https://api.flutter.dev/flutter/material/TimeOfDay-class.html)]{.type-annotation} [initialTime]{.parameter-name}]{#customTimePicker-param-initialTime .parameter}}) [→ [Future](https://api.flutter.dev/flutter/dart-core/Future-class.html)[\<[[TimeOfDay](https://api.flutter.dev/flutter/material/TimeOfDay-class.html)]{.type-parameter}\>]{.signature}]{.returntype .parameter} ]{.signature}
