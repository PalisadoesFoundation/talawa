...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="" below-sidebar="models_chats_chat_user/models_chats_chat_user-library-sidebar.html"}
<div>

# [models/chats/chat_user]{.kind-library} library
...
[[ChatUser](../models_chats_chat_user/ChatUser-class.html)]{.name}
:   This class creates JSON code for chat user using the
