...
[[PostBottomModal](../widgets_post_modal/PostBottomModal/PostBottomModal.html)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?] key, ][dynamic function([[[Post](../models_post_post_model/Post-class.html)]])?, ][dynamic deletePost([[[Post](../models_post_post_model/Post-class.html)]])?, ][required [[Post](../models_post_post_model/Post-class.html)] post]})]
...
[[deletePost](../widgets_post_modal/PostBottomModal/deletePost.html)] [→ dynamic Function[([[[Post](../models_post_post_model/Post-class.html)]])]?]
...
[[function](../widgets_post_modal/PostBottomModal/function.html)] [→ dynamic Function[([[[Post](../models_post_post_model/Post-class.html)]])]?]
...
[[post](../widgets_post_modal/PostBottomModal/post.html)] [→ [Post](../models_post_post_model/Post-class.html)]
...
[[build](../widgets_post_modal/PostBottomModal/build.html)][([[[BuildContext](https://api.flutter.dev/flutter/widgets/BuildContext-class.html)] context]) [→ [Widget](https://api.flutter.dev/flutter/widgets/Widget-class.html)] ]
