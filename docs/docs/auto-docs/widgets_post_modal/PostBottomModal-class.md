...
[[PostBottomModal](../widgets_post_modal/PostBottomModal/PostBottomModal.md)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.md)?] key, ][dynamic function([[[Post](../models_post_post_model/Post-class.md)]])?, ][dynamic deletePost([[[Post](../models_post_post_model/Post-class.md)]])?, ][required [[Post](../models_post_post_model/Post-class.md)] post]})]
