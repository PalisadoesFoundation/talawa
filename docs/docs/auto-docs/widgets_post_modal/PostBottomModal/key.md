...
and [key](../../widgets_post_modal/PostBottomModal/key.md) properties
of the two widgets are
[operator==](../../widgets_post_modal/PostBottomModal/operator_equals.md),
...
[key](../../widgets_post_modal/PostBottomModal/key.md) allows the
