...
<span class="name">[createState](../views_after_auth_screens_chat_widgets_group_member_selector/GroupMemberSelector/createState.md)</span><span class="signature"> <span class="returntype parameter">→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)<span class="signature">\<<span class="type-parameter">[GroupMemberSelector](../views_after_auth_screens_chat_widgets_group_member_selector/GroupMemberSelector-class.md)</span>\></span></span> </span>  
