...
<span class="name">[ExploreEventDialog.new](../views_after_auth_screens_events_explore_event_dialogue/ExploreEventDialog/ExploreEventDialog.md)</span><span class="signature"></span>  
