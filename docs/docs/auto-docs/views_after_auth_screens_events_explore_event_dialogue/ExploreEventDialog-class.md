...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="views_after_auth_screens_events_explore_event_dialogue/views_after_auth_screens_events_explore_event_dialogue-library-sidebar.html" below-sidebar="views_after_auth_screens_events_explore_event_dialogue/ExploreEventDialog-class-sidebar.html"}
<div>

# [ExploreEventDialog]{.kind-class} class
...
[[ExploreEventDialog](../views_after_auth_screens_events_explore_event_dialogue/ExploreEventDialog/ExploreEventDialog.html)]{.name}[({[required [[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)]{.type-annotation} [key]{.parameter-name}]{#-param-key .parameter}})]{.signature}
...
[[createState](../views_after_auth_screens_events_explore_event_dialogue/ExploreEventDialog/createState.html)]{.name}[() [→ \_ExploreEventDialogState]{.returntype .parameter} ]{.signature}
