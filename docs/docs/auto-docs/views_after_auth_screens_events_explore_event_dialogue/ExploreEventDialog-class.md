...
[[ExploreEventDialog](../views_after_auth_screens_events_explore_event_dialogue/ExploreEventDialog/ExploreEventDialog.html)][({[required [[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)] key]})]
...
[createState](../views_after_auth_screens_events_explore_event_dialogue/ExploreEventDialog/createState.html) [→ \_ExploreEventDialogState ]
