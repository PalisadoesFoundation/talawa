...
and
[key](../../views_after_auth_screens_events_explore_event_dialogue/ExploreEventDialog/key.md)
properties of the two widgets are
[operator==](../../views_after_auth_screens_events_explore_event_dialogue/ExploreEventDialog/operator_equals.md),
