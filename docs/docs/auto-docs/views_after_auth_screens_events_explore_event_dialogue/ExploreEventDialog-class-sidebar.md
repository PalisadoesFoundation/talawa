1.  [Constructors](./ExploreEventDialog-class.md)
2.  [ExploreEventDialog](./ExploreEventDialog/ExploreEventDialog.md)
3.  [Properties](./ExploreEventDialog-class.md)
...
7.  [Methods](./ExploreEventDialog-class.md)
...
19. [Operators](./ExploreEventDialog-class.md)
20. [operator
