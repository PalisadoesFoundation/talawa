...
and [key](../../plugin_plugin_injector/PluginInjector/key.md)
properties of the two widgets are
[operator==](../../plugin_plugin_injector/PluginInjector/operator_equals.md),
...
[key](../../plugin_plugin_injector/PluginInjector/key.md) allows the
