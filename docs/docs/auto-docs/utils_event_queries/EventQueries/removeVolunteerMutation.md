...
# <span class="kind-method">removeVolunteerMutation</span> method
...
<span class="name">removeVolunteerMutation</span>
...
- `String`: Returns a GraphQL mutation string to delete a volunteer to a
  group.
