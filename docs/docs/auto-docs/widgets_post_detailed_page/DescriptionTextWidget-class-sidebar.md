1.  [Constructors](./DescriptionTextWidget-class#constructors.md)
2.  [DescriptionTextWidget](./DescriptionTextWidget/DescriptionTextWidget.md)
3.  [Properties](./DescriptionTextWidget-class#instance-properties.md)
...
8.  [Methods](./DescriptionTextWidget-class#instance-methods.md)
...
20. [Operators](./DescriptionTextWidget-class#operators.md)
21. [operator
