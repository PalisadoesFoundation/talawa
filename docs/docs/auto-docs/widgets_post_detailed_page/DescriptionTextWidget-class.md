:::::::::: {#dartdoc-main-content .main-content above-sidebar="widgets_post_detailed_page/widgets_post_detailed_page-library-sidebar.html" below-sidebar="widgets_post_detailed_page/DescriptionTextWidget-class-sidebar.html"}
<div>

# [DescriptionTextWidget]{.kind-class} class
...
[[DescriptionTextWidget](../widgets_post_detailed_page/DescriptionTextWidget/DescriptionTextWidget.html)]{.name}[({[required [[String](https://api.flutter.dev/flutter/dart-core/String-class.html)]{.type-annotation} [text]{.parameter-name}]{#-param-text .parameter}})]{.signature}
...
[[text](../widgets_post_detailed_page/DescriptionTextWidget/text.html)]{.name} [→ [String](https://api.flutter.dev/flutter/dart-core/String-class.html)]{.signature}
...
[[createState](../widgets_post_detailed_page/DescriptionTextWidget/createState.html)]{.name}[() [→ \_DescriptionTextWidgetState]{.returntype .parameter} ]{.signature}
