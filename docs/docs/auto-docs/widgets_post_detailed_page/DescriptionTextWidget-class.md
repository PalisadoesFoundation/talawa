...
[[DescriptionTextWidget](../widgets_post_detailed_page/DescriptionTextWidget/DescriptionTextWidget.md)][({[required [[String](https://api.flutter.dev/flutter/dart-core/String-class.md)] text]})]
