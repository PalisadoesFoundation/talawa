...
<span class="name">[createState](../views_after_auth_screens_profile_user_feed/UserFeed/createState.md)</span><span class="signature"> <span class="returntype parameter">→ [State](https://api.flutter.dev/flutter/widgets/State-class.html)<span class="signature">\<<span class="type-parameter">[UserFeed](../views_after_auth_screens_profile_user_feed/UserFeed-class.md)</span>\></span></span> </span>  
