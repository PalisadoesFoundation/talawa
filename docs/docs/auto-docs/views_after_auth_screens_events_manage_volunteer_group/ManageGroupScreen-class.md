...
::: {role="main"}
::: {#dartdoc-main-content .main-content above-sidebar="views_after_auth_screens_events_manage_volunteer_group/views_after_auth_screens_events_manage_volunteer_group-library-sidebar.html" below-sidebar="views_after_auth_screens_events_manage_volunteer_group/ManageGroupScreen-class-sidebar.html"}
<div>

# [ManageGroupScreen]{.kind-class} class
...
[[ManageGroupScreen](../views_after_auth_screens_events_manage_volunteer_group/ManageGroupScreen/ManageGroupScreen.html)]{.name}[({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.html)?]{.type-annotation} [key]{.parameter-name}, ]{#-param-key .parameter}[required [[EventVolunteerGroup](../models_events_event_volunteer_group/EventVolunteerGroup-class.html)]{.type-annotation} [group]{.parameter-name}, ]{#-param-group .parameter}[required [[Event](../models_events_event_model/Event-class.html)]{.type-annotation} [event]{.parameter-name}]{#-param-event .parameter}})]{.signature}
...
[[event](../views_after_auth_screens_events_manage_volunteer_group/ManageGroupScreen/event.html)]{.name} [→ [Event](../models_events_event_model/Event-class.html)]{.signature}
:   The event to which the volunteer group belongs.
    ::: features
    [final]{.feature}
    :::

[[group](../views_after_auth_screens_events_manage_volunteer_group/ManageGroupScreen/group.html)]{.name} [→ [EventVolunteerGroup](../models_events_event_volunteer_group/EventVolunteerGroup-class.html)]{.signature}
