...
[[ManageGroupScreen](../views_after_auth_screens_events_manage_volunteer_group/ManageGroupScreen/ManageGroupScreen.md)][({[[[Key](https://api.flutter.dev/flutter/foundation/Key-class.md)?] key, ][required [[EventVolunteerGroup](../models_events_event_volunteer_group/EventVolunteerGroup-class.md)] group, ][required [[Event](../models_events_event_model/Event-class.md)] event]})]
